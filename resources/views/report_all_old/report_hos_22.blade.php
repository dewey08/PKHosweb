...
@section('title', 'PK-OFFICER || Report-จำนวนผู้ป่วย ESRD+EGFRน้อยกว่า6')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_22') }}" method="GET">
                @csrf

            <div class="row"> 
                <div class="col-md-3">
                    <h5 class="card-title" style="color:blueviolet">ตัวชี้วัดสำคัญใน โรงพยาบาล</h5>
                    <p class="card-title-desc">จำนวนผู้ป่วย ESRD+EGFRน้อยกว่า6</p>
                </div>
                <div class="col"></div>
