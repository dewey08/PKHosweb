...
@section('title', 'PK-OFFICER || Report-จำนวนผู้ป่วยที่มารับบริการใน IPD ทั้งหมด (HN)')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_32') }}" method="GET">
                @csrf
                                ...
                                style=" border-spacing: 0; width: 100%;"> --}}
                                    <thead>
                                        <tr>                                          
                                            ...
                                            <th class="text-center" width="5%">totIPDHN</th>                                   
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i = 1; ?>
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-center" width="5%">{{$item->totIPDHN}}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
