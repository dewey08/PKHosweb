...
@section('title', 'PK-OFFICER || Report-จำนวนผู้ป่วย upper abdominal with pneumonia')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_30') }}" method="GET">
                @csrf
                                ...
                                style=" border-spacing: 0; width: 100%;"> --}}
                                    <thead>
                                        <tr>                                          
                                            ...
                                            <th class="text-center" width="5%">op0</th>  
                                            <th class="text-center" width="5%">op1</th> 
                                            <th class="text-center" width="5%">op2</th>
                                            <th class="text-center" width="5%">op3</th>
                                            <th class="text-center" width="5%">op4</th>
                                            <th class="text-center" width="5%">op5</th>
                                            <th class="text-center" width="5%">op6</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i = 1; ?>
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-start"  width="3%">{{$item->pdx}}</td> 
                                                <td class="text-center" width="3%">{{$item->dx0}}</td> 
                                                <td class="text-center" width="3%">{{$item->dx1}}</td>
                                                <td class="text-start"  width="3%">{{$item->dx2}}</td> 
                                                <td class="text-center" width="3%">{{$item->dx3}}</td> 
                                                <td class="text-center" width="3%">{{$item->dx4}}</td>
                                                <td class="text-center" width="3%">{{$item->dx5}}</td>
                                                <td class="text-center" width="5%">{{$item->name}}</td>
