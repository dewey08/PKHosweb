...
@section('title', 'PK-OFFICER || Report-จำนวนผู้ป่วย IPD Cardiac arrest')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_23') }}" method="GET">
                @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-center" width="5%">{{$item->fullname}}</td>
                                                ...
                                                <td class="text-center" width="4%">{{$item->doctorname}}</td>
