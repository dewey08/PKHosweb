...
@section('title', 'PK-OFFICER || Report-จำนวนผู้ป่วย unplan จาก ward ย้ายไป ICU <6 ชม')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_29') }}" method="GET">
                @csrf
                                ...
                                style=" border-spacing: 0; width: 100%;"> --}}
                                    <thead>
                                        <tr>                                          
                                            ...
                                            <th class="text-center" width="5%">dchdate</th>
                                            <th class="text-center" width="5%">ptname</th>  
                                            <th class="text-center" width="5%">age_y</th> 
                                            <th class="text-center" width="5%">admdate</th>
                                            <th class="text-center" width="5%">pdx</th>
                                            <th class="text-center" width="5%">name</th>
                                            <th class="text-center" width="5%">doc</th>
                                            <th class="text-center" width="5%">firstward</th>
                                            <th class="text-center" width="5%">wardname</th>
                                            <th class="text-center" width="5%">movetime</th>
                                            <th class="text-center" width="5%">regtime</th>                          
                                            <th class="text-center" width="5%">datemove</th>
                                            <th class="text-center" width="5%">timemove</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i = 1; ?>
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-center" width="3%">{{$item->ptname}}</td> 
                                                <td class="text-start"  width="3%">{{$item->age_y}}</td> 
                                                <td class="text-center" width="3%">{{$item->admdate}}</td> 
                                                <td class="text-center" width="3%">{{$item->pdx}}</td>
                                                <td class="text-start"  width="3%">{{$item->name}}</td> 
                                                <td class="text-center" width="3%">{{$item->doc}}</td>
                                                <td class="text-center" width="3%">{{$item->firstward}}</td> 
                                                <td class="text-center" width="3%">{{$item->wardname}}</td>                                      
                                                <td class="text-center" width="3%">{{$item->movetime}}</td> 
                                                <td class="text-center" width="3%">{{$item->regtime}}</td> 
                                                <td class="text-center" width="3%">{{$item->datemove}}</td> 
                                                <td class="text-center" width="3%">{{$item->timemove}}</td> 
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
