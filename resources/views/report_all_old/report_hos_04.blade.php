...
@section('title', 'PK-OFFICER || Report-(Died) จำนวนผู้ป่วยที่เสียชีวิตใน รพ ด้วย soft skin and soft tissue infection')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_04') }}" method="GET">
                @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-start"  width="4%">{{ $item->an }}</td> 
                                                ...
                                                <td class="text-start" width="5%">{{ $item->doctorname }}</td>  
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
