...
@section('title', 'PK-OFFICER || Report-จำนวนผู้ป่วย NF+DBภายใน24')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_25') }}" method="GET">
                @csrf

            <div class="row"> 
                <div class="col-md-3">
                    <h5 class="card-title" style="color:blueviolet">ตัวชี้วัดสำคัญใน โรงพยาบาล</h5>
                    <p class="card-title-desc">จำนวนผู้ป่วย NF+DBภายใน24</p>
                </div>
                <div class="col"></div>
                                ...
                                style=" border-spacing: 0; width: 100%;"> --}}
                                    <thead>
                                        <tr>                                          
                                            ...
                                            <th class="text-center" width="5%">enter_date</th> 
                                            <th class="text-center" width="5%">enter_time</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-start"  width="3%">{{$item->enter_date}}</td> 
                                                <td class="text-center" width="3%">{{$item->enter_time}}</td> 
                                                <td class="text-center" width="3%">{{$item->date}}</td>                                    
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
