...
@section('title', 'PK-OFFICER || Report-(Died) จำนวนผู้ป่วยที่เสียชีวิตใน รพ.IPD')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_06') }}" method="GET">
                @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-start" width="5%">{{ $item->dchdate }}</td>
                                                <td class="text-center" width="5%">{{ $item->admdate }}</td>
                                                <td class="text-start" width="5%">{{ $item->wardname }}</td>  
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
