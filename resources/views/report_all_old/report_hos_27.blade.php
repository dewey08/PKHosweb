...
@section('title', 'PK-OFFICER || Report-จำนวนผู้ป่วย OPD Cardiac arrest เฉพาะ ER')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_26') }}" method="GET">
                @csrf
                                ...
                                style=" border-spacing: 0; width: 100%;"> --}}
                                    <thead>
                                        <tr>                                          
                                            ...
                                            <th class="text-center" width="5%">doctorname</th>                          
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i = 1; ?>
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-center" width="3%">{{$item->fullname}}</td> 
                                                ...
                                                <td class="text-center" width="3%">{{$item->doctorname}}</td>                                      
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
