...
@section('title', 'PK-OFFICER || Report-(Died) จำนวนผู้ป่วยที่เสียชีวิตใน รพ.ER')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_05') }}" method="GET">
                @csrf
                                ...
                                style=" border-spacing: 0; width: 100%;"> --}}
                                    <thead>
                                        <tr>                                          
                                            ...
                                            <th class="text-center">death_diag_other</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-start"  width="4%">{{ $item->age }}</td>                                                
                                                ...
                                                <td class="text-center" width="5%">{{ $item->death_diag_other }}</td>
