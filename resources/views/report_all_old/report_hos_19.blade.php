...
@section('title', 'PK-OFFICER || Report-จำนวนครั้งที่มารับบริการใน IPD ทั้งหมด (AN)')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_19') }}" method="GET">
                @csrf
                                ...
                                style=" border-spacing: 0; width: 100%;"> --}}
                                    <thead>
                                        <tr>                                          
                                            ...
                                            <th class="text-center" width="5%">totIPDAN</th>                                   
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i = 1; ?>
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-center" width="5%">{{$item->totIPDAN}}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
