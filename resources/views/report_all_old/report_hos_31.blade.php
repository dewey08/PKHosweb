...
@section('title', 'PK-OFFICER || Report-จำนวนผู้ป่วย ผ่าตัด upper abdominal')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_31') }}" method="GET">
                @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-center" width="5%">{{$item->enter_date}}</td>
                                                <td class="text-center" width="3%">{{$item->ptname}}</td>
                                                <td class="text-start"  width="3%">{{$item->an}}</td>
