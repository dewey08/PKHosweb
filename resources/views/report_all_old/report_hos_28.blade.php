...
@section('title', 'PK-OFFICER || Report-จำนวนผู้ป่วย readmit <28')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_28') }}" method="GET">
                @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-center" width="3%">{{$item->lastdate}}</td> 
                                                <td class="text-start"  width="3%">{{$item->regdate}}</td> 
                                                <td class="text-center" width="3%">{{$item->lastvisit}}</td> 
                                                <td class="text-center" width="3%">{{$item->dchdate}}</td>
                                                <td class="text-start"  width="3%">{{$item->admdate}}</td> 
