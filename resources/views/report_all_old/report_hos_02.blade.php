...
@section('title', 'PK-OFFICER || Report-(Died) in hos covid IPD >=15')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_02') }}" method="GET">
                @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-center" width="5%">{{ $item->death_date }}</td> 
                                                <td class="text-center" width="5%">{{ $item->ptname }}</td> 
                                                <td class="text-start" >{{ $item->sexname }}</td>  
                                                <td class="text-center" width="5%">{{ $item->age_y }}</td> 
                                                <td class="text-start" >{{ $item->death_diag_1 }}</td> 
                                                <td class="text-center" width="5%">{{ $item->death_diag_2 }}</td> 
                                                <td class="text-center" width="5%">{{ $item->death_diag_3 }}</td> 
                                                <td class="text-center" width="5%">{{ $item->death_diag_4 }}</td> 
                                                ...
                                                <td class="text-center" width="5%">{{ $item->doctorname }}</td>  
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
