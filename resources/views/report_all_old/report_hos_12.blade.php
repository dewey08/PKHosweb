...
@section('title', 'PK-OFFICER || Report-จำนวน Respiratory failure with covid IPD >=15ปี')
...
@section('content')
    ...
    ?>
        ...
        <div class="tabs-animation">
            ...
            <form action="{{ url('report_hos_12') }}" method="GET">
                @csrf
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hos_a as $item) 
                                            <tr>                                                  
                                                ...
                                                <td class="text-start"  width="4%">{{ $item->dx3}}</td> 
                                                <td class="text-center" width="5%">{{ $item->dx4}}</td>
                                                <td class="text-start" width="5%">{{ $item->dx5}}</td>
                                                <td class="text-center" width="5%">{{ $item->name}}</td>
                                                <td class="text-center" width="3%">{{ $item->op0}}</td> 
                                                <td class="text-center" width="3%">{{ $item->op1}}</td> 
                                                <td class="text-center" width="3%">{{ $item->op2}}</td>
                                                <td class="text-start"  width="4%">{{ $item->op3}}</td> 
                                                <td class="text-center" width="5%">{{ $item->op4}}</td>
                                                <td class="text-start" width="5%">{{ $item->op5}}</td>
                                                <td class="text-center" width="5%">{{ $item->op6}}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
