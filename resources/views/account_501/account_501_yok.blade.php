                ...
                <div class="card card_audit_4c">
                    ...
                    <div class="card-body">
                            ...
                            <tr style="background-color: #f3fca1">
                                ...
                                <td class="text-end" style="background-color: #0395a0" ><label for="" style="color: #FFFFFF">{{ number_format($total2, 2) }}</label></td>
                                <td class="text-end" style="background-color: #063c79"><label for="" style="color: #FFFFFF">{{ number_format($total3, 2) }}</label> </td> 
                            </tr>  
                        </table>
                    </div>
                </div>
