...
<div class="tabs-animation">
    ...
    <div id="preloader">
        <div id="status">
            ...
            <form action="{{ route('acc.account_501_dash') }}" method="GET">
                @csrf
                <div class="row"> 
                    <div class="col"></div>
                    <div class="col-md-7">
                        <h4 class="card-title" style="color:green">Detail 1102050101.501</h4>
                        <p class="card-title-desc">รายละเอียดข้อมูล ผัง 1102050101.501</p>
                    </div>
                    {{-- <div class="col"></div> --}}
                                            ...
                                            <?php
                                                ...
                                                $datas = DB::select(
                                                    'SELECT count(DISTINCT vn) as Can,SUM(debit_total) as sumdebit
                                                        FROM acc_debtor
                                                        WHERE account_code="1102050101.501"
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end" style="color:rgb(6, 82, 170);background-color: rgb(203, 227, 255)" width="10%">
                                                        <a href="{{url('account_501_pull')}}" target="_blank" style="color:rgb(5, 58, 173);"> {{ number_format($sum_N, 2) }}</a>
                                                    </td>                                                    
                                                    <td class="text-end" style="color:rgb(231, 73, 139);background-color: rgb(203, 227, 255)" width="10%"> 
                                                        <a href="{{url('account_501_detail/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(231, 73, 139);"> {{ number_format($total_sumY, 2) }}</a> 
                                                    </td> 
                                                    ...
                                                    <td class="text-end" style="color:rgb(224, 128, 17)" width="10%">  
                                                        <a href="{{url('account_501_yok/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(224, 128, 17);"> {{ number_format($sum_yokpai, 2) }}</a> 
                                                    </td>
                                                </tr>
                                            <?php
