...
@section('title', 'PK-OFFICER || Document')
...
@section('content')
    ...
    <script>
        ...
        {{-- <div class="tabs-animation">
            ...
            <div class="row">
                <div class="col-md-4">
                    <h4 class="card-title" style="color: rgb(3, 141, 123)">Register Document</h4>
                    <p class="card-title-desc">ทะเบียนเอกสารต่างๆ</p>
                </div>
                <div class="col"></div>
                    ...
                    <div class="app-page-title app-page-title-simple">
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-actions"> 
                                {{-- <a href="" data-bs-toggle="modal" target="_blank" data-bs-target="#exampleModal">
            ...
            <div class="row"> 
                <div class="col-xl-6">
                    <div class="card card_audit_4c p-2">   
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datashow as $item) 
                                        <tr style="font-size: 13px" id="sid{{$item->document_id}}">                                                
                                            ...
                                            <td class="p-2">
                                                <a href="{{url('tree_documentsub/'.$item->document_id)}}"> {{ $item->document_name }}</a> 
                                            </td> 
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content"> 
                                                        <div class="modal-body">
                                                            <form method="POST" action="{{ route('d.tree_document_update') }}" id="update_Form" enctype="multipart/form-data">
                                                                @csrf
                                                                <br>
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group"> 
                                                                                    ...
                                                                                    @else
                                                                                            ...
                                                                                            @else
                                                                                                <img src="{{asset('storage/tree_document/'.$item->img)}}" id="add_upload_preview" width="450px" height="380px" alt="Image" class="img-thumbnail"> 
                                                                                            @endif
                ...
                <div class="col-xl-6">
                    <div class="card card_audit_4c p-4">  
                            {{-- <iframe src="{{ asset('storage/instrument/PTTinst_sss_todtan.pdf' ) }}" height="700px" width="100%"></iframe>  --}}
                    </div> 
                </div>   
            </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"> 
            ...
            <div class="modal-content"> 
                    <div class="modal-body">
                        <form method="POST" action="{{ route('d.tree_document_save') }}" id="insert_Form" enctype="multipart/form-data">
                            @csrf
                            <br>
