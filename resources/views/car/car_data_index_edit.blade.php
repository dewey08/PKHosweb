@extends('layouts.car')
@section('title', 'PK-OFFICER || ยานพาหนะ')
@section('content')
    <script>
        function TypeAdmin() {
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body shadow-lg">
                        <form action="{{ route('car.car_data_index_update') }}" method="POST" id="update_carForm"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="hidden" id="article_decline_id" name="article_decline_id"
                                        class="form-control" value="6" />
                                    <input type="hidden" id="article_categoryid" name="article_categoryid"
                                        class="form-control" value="26" />
                                    <input type="hidden" id="article_typeid" name="article_typeid" class="form-control"
                                        value="2" />
                                    <input type="hidden" id="article_groupid" name="article_groupid" class="form-control"
                                        value="3" />
                                    <input type="hidden" name="store_id" id="store_id"
                                        value=" {{ Auth::user()->store_id }}">
                                    <input type="hidden" name="article_id" id="article_id"
                                        value="{{ $dataedits->article_id }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                <input id="article_recieve_date" type="date" class="form-control"
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                <input id="article_price" type="text" class="form-control"
                                                    name="article_price" value="{{ $dataedits->article_price }}">
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <select id="article_status_id" name="article_status_id"
                                                    ...
                                                    @foreach ($article_status as $status)
                                                        @if ($dataedits->article_status_id == $status->article_status_id)
                                                            <option value="{{ $status->article_status_id }}" selected>
                                                                {{ $status->article_status_name }} </option>
                                                        @else
                                                            <option value="{{ $status->article_status_id }}">
                                                                {{ $status->article_status_name }} </option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                <select id="article_car_type_id" name="article_car_type_id"
                                                    class="form-control show_type" style="width: 100%">
                                                    <option value=""></option>
                                                    @foreach ($car_type as $car)
                                                        @if ($dataedits->article_car_type_id == $car->car_type_id)
                                                            <option value="{{ $car->car_type_id }}" selected>
                                                                {{ $car->car_type_name }}</option>
                                                        @else
                                                            <option value="{{ $car->car_type_id }}">
                                                                {{ $car->car_type_name }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-3 mt-2">
                                            <div class="form-group ">
                                                <input type="text" id="CAR_TYPE_INSERT" name="CAR_TYPE_INSERT"
                                                    class="form-control form-control-sm shadow bga"
                                                    placeholder="ถ้าไม่มีประเภทให้เพิ่ม" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                <select id="article_brand_id" name="article_brand_id"
                                                    class="form-control show_brand" style="width: 100%">
                                                    <option value=""></option>
                                        ...
                                        <div class="col-md-3 mt-2">
                                            <div class="form-group ">
                                                <input type="text" id="CAR_MODEL_INSERT" name="CAR_MODEL_INSERT"
                                                    class="form-control form-control-sm shadow bga"
                                                    placeholder="ถ้าไม่มียี่ห้อให้เพิ่ม" />
                                            </div>
                                        </div>
                                        <div class="col-md-1 mt-2">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                <select id="article_color_id" name="article_color_id"
                                                    class="form-control show_color" style="width: 100%">
                                                    <option value=""></option>
                                        ...
                                        <div class="col-md-3 mt-2">
                                            <div class="form-group ">
                                                <input type="text" id="CAR_COLOR_INSERT" name="CAR_COLOR_INSERT"
                                                    class="form-control form-control-sm shadow bga" placeholder="ถ้าไม่มีสีให้เพิ่ม" />
                                            </div>
                                        </div>
                                        <div class="col-md-1 mt-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                <input id="article_year" type="text" class="form-control"
                                                    name="article_year" value="{{ $dataedits->article_year }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2 mt-2">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                <input id="article_car_number" type="text" class="form-control"
                                                    ...
                                                    value="{{ $dataedits->article_car_number }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2 mt-2">
                                                    ...
                                                    @foreach ($department_sub_sub as $deb_subsub)
                                                        @if ($dataedits->article_deb_subsub_id == $deb_subsub->DEPARTMENT_SUB_SUB_ID)
                                                            <option value="{{ $deb_subsub->DEPARTMENT_SUB_SUB_ID }}"
                                                                selected> {{ $deb_subsub->DEPARTMENT_SUB_SUB_NAME }}
                                                            </option>
                                                        @else
                                                            <option value="{{ $deb_subsub->DEPARTMENT_SUB_SUB_ID }}">
                    ...
                    <div class="card-footer">
                        <div class="col-md-12 text-end">
                            <div class="form-group">
                                ...
                                <a href="{{ url('car/car_data_index') }}" class="btn btn-danger btn-sm">
