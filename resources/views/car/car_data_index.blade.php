            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header ">
                        <form action="{{ url('car/car_data_indexsearch') }}" method="POST">
                            @csrf
                        <div class="row">
                            ...
                            <div class="col"></div>
                            <div class="col-md-1 text-end">ทะเบียน</div>
                            <div class="col-md-3 text-center">
                                <div class="input-group" > 
                                   <select id="article_register" name="article_register" class="form-select form-select-lg" style="width: 100%">
                                    <option value="">--เลือก--</option>
                                    @foreach ($articleregister as $reqshow)
                                    @if ($req == $reqshow->article_id)
                                        <option value="{{ $reqshow->article_id }}" selected> {{ $reqshow->article_register }} </option>
                                    @else
                                        <option value="{{ $reqshow->article_id }}"> {{ $reqshow->article_register }} </option>
                                    @endif
                            ...
                            <table class="table table-hover table-bordered table-sm myTable" style="width: 100%;"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th width="20%" class="text-center">หมวดครุภัณฑ์</th>
                                        <th width="15%" class="text-center">ประจำหน่วยงาน</th>
                                        <th width="10%" class="text-center">ทะเบียน</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($article_data as $item)
                                        <tr id="sid{{ $item->article_id }}">
                                            ...
                                            {{-- <td class="p-2" width="15%">{{ $item->decline_name }}</td> --}}
                                            <td class="p-2" width="20%">{{ $item->category_name }}</td>
                                            <td class="p-2" width="15%">{{ $item->DEPARTMENT_SUB_SUB_NAME }}</td>
                                            <td class="p-2" width="15%">{{ $item->article_register }}</td>
