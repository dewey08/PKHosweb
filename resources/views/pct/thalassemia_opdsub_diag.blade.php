                ...
                <div class="card">
                    ...
                    <div class="card-body shadow-lg">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                @foreach ($datashow_diagipd as $item)
                                    <tr>
                                        <td>{{ $i++ }}</td>                                        
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('thalassemia_opdsub_diag_an/'.$item->an)}}" target="_blank">{{ $item->icd10 }}</a>  
                                        </td>
                                        <td class="p-2">
                                            <a href="{{url('thalassemia_opdsub_diag_lab/'.$item->an)}}" target="_blank">{{ $item->listlab }}</a>   
                                        </td>
                                        <td class="text-center">{{ $item->nname }}</td> 
                                        <td class="text-center">
                                            <a href="{{url('thalassemia_opdsub_diag_blood/'.$item->an)}}" target="_blank">{{ $item->blood }}</a>  
                                        </td>
                ...
                <div class="card">
                    ...
                    <div class="card-body shadow-lg">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                @foreach ($datashow_diagopd as $item2)
                                    <tr>
                                        <td>{{ $i++ }}</td>                                        
                                        ...
                                        <td class="text-center"> 
                                            <a href="{{url('thalassemia_opdsub_diag_vn/'.$item2->vn)}}" target="_blank">{{ $item2->pdx }}</a>  
                                        </td>
                                        <td class="p-2">
                                            <a href="{{url('thalassemia_opdsub_diag_labvn/'.$item2->vn)}}" target="_blank">{{ $item2->listlab }}</a>   
                                        </td>
                                        <td class="text-center"> {{ $item2->nname }} </td> 
