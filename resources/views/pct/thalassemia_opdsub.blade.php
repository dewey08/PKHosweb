                                ...
                                @foreach ($datashow_opd as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('thalassemia_opdsub_diag/'.$item->hn.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{ $item->pdx }}</a>  
                                        </td> 
                                        <td class="text-center">
                                            <a href="{{url('thalassemia_opdsub_drugvn/'.$item->vn)}}" target="_blank">{{ $item->xx }}</a>  
                                        </td>
