...
<div class="tabs-animation">
    ...
    <form action="{{ url('ofc_ipd') }}" method="POST">
        @csrf
    <div class="row"> 
            <div class="col-md-3">
            ...
            <div class="col-md-6 text-end">
                <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker1'>
                    ...
                    <button type="button" class="btn-icon btn-shadow btn-dashed btn btn-outline-success card_fdh_4 Claim" data-url="{{url('ofc_ipd_process')}}">
                        {{-- <i class="fa-solid fa-spinner text-success me-2"></i> --}}
                        <i class="fa-solid fa-2 text-success me-2"></i>
                        ส่งเคลม
                    </button>
                   
                    <a href="{{url('ofc_ipd_export')}}" class="btn-icon btn-shadow btn-dashed btn btn-outline-danger card_fdh_4">
                        {{-- <i class="fa-solid fa-file-export text-danger me-2"></i> --}}
                        <i class="fa-solid fa-3 text-danger me-2"></i>
                        Export Txt
                    </a> 
                    {{-- <a href="{{url('ofc_main_zip')}}" class="btn-icon btn-shadow btn-dashed btn btn-outline-primary card_fdh_4"> 
        ...
        <div class="col-xl-12">
            <div class="card card_fdh_4">
                ...
                <div class="card-body">
                    {{-- <div class="row"> 
                        <div class="col-md-2">
                            <button type="button" class="ladda-button me-2 btn-pill btn btn-warning cardacc Active" data-url="{{url('ofc_main_active')}}">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            {{-- <div class="col-md-2">
                                <button type="button" class="ladda-button btn-pill btn btn-warning cardacc Active" data-url="{{url('ofc_main_active')}}">
                                    <i class="fa-solid fa-sack-dollar me-2"></i>
                                   ปรับ Active
                               </button>
                            </div>   --}}
                                    ...
                                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                            <tr style="font-size: 13px">
                                                ...
                                                <th class="text-center">Lab Covid</th> 
                                                ...
                                                <tr height="20" style="font-size: 12px;"> 
                                                    ...
                                                    <td class="text-center" width="5%">
                                                        @if ($item->error_c != NULL) 
                                                            <span class="bg-danger badge me-2">{{ $item->error_c }}</span>
                                                        @else
                                                    ...
                                                    <td class="p-2" width="7%">{{ $item->icd10 }}</td>
                                                    <td class="text-center" width="5%">{{ number_format($item->debit, 2) }}</td>                                                    
                                                    <td class="text-end" width="7%" style="font-size: 15px;color:blue">{{$item->covid}}</td> 
                                                    <td class="text-center" width="5%">{{ $item->labcovid }}</td> 
    ...
    $(document).ready(function() {
        ...
        $('.Active').on('click', function(e) {
            ...
            if (allValls.length <= 0) {
                ...
                Swal.fire({
                    title: 'Are you Want Active sure?',
                    text: "คุณต้องการปรับ Active รายการนี้ใช่ไหม!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                                ...
                                $.ajax({
                                    ...
                                    success:function(data){ 
                                            if (data.status == 200) {
                                                ...
                                                Swal.fire({
                                                    title: 'ปรับข้อมูลเคลมสำเร็จ',
                                                    text: "You Active data success",
                                                    icon: 'success',
                                                    showCancelButton: false,
                                                    confirmButtonColor: '#06D177',
                                                    confirmButtonText: 'เรียบร้อย'
