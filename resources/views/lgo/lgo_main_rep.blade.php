            ...
            <div class="col-xl-8 col-md-6">
                <div class="card cardacc">
                    <div class="grid-menu-col">
                        <form action="{{ route('fdh.lgo_main_repsave') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if ($countc > 0)  
                                        <a href="{{ url('lgo_main_repsenddata') }}" class="mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-primary" id="Senddata">
                ...
                complete: function(xhr) { 
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location = "{{ url('lgo_main_rep') }}";
                        }
                    })
                }
            })
