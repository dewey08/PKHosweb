...
<div class="tabs-animation">
    ...
    <form action="{{ url('lgo_801') }}" method="POST">
            @csrf
    <div class="row"> 
            <div class="col"></div>
            ...
            {{-- <div class="col-md-4">  --}}
                    ...
                    {{-- 
                    <a href="{{url('lgo_801_export')}}" class="btn-icon btn-shadow btn-dashed btn btn-outline-danger">
                                    ...
                                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr height="20" style="font-size: 12px;">
                                                ...
                                                <td class="text-center" width="10%">{{ $item1->price_lgo }}</td> 
                                            </tr>
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, pull it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('claim.lgo_801_process') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, send it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('claim.lgo_801_send_api') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, send it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('claim.lgo_801_export_api') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
