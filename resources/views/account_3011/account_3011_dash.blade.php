   ...
   <div class="tabs-animation">
    ...
    <div id="preloader">
        ...
        <form action="{{ url('account_301_dash') }}" method="GET">
            ...
            <div class="row mt-2"> 
                <div class="col-md-3">
                    <h4 class="card-title" style="color:rgb(10, 151, 85)">Detail 1102050101.3011</h4>
                                    ...
                                    <div class="flex-grow-1 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 text-end mt-2 me-2">
                                                <a href="{{url('account_3011_pull')}}" target="_blank">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col"></div>
                                            <div class="col-md-5 text-end me-2">
                                                <a href="{{url('account_3011_dashsub/'.$item->acc_trimart_start_date.'/'.$item->acc_trimart_end_date)}}" target="_blank">
