                        ...
                        <!-- Pills navs -->
                            <ul class="nav nav-pills" id="ex1" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    ...
                                    <a class="nav-link active" href="{{url('user_book/user_book_send_fileopen/'.$dataedits->bookrep_id)}}" >&nbsp;&nbsp;&nbsp;<label class="xl">การเปิดอ่าน</label>&nbsp;&nbsp;&nbsp;&nbsp; </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                                ...
                                                <table class="table table-hover table-bordered table-sm myTable"
                                                    ...
                                                    <thead>
                                                        <tr height="10px">
                                                            ...
                                                            <th class="text-center">วันที่อ่าน</th> 
                                                            <th class="text-center">เวลาอ่าน</th> 
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php $num = 1;
                                                        $date = date('Y'); ?>
                                                        @foreach ($book_read as $item3)
                                                            <tr id="sid{{ $item3->book_read_id }}">
                                                                <td class="text-center" width="5%" style="font-size: 13px;">{{ $num++ }}</td>
                                                                <td class="p-2">{{ $item3->prefix_name }}{{ $item3->fname }}  {{ $item3->lname }}</td>
                                                                <td class="p-2" width="15%" style="font-size: 13px;">{{ $item3->book_read_open_date }}</td>
                                                                <td class="p-2" width="15%" style="font-size: 13px;">{{ $item3->book_read_open_time }}</td>
                                                            </tr>
                                                        @endforeach
