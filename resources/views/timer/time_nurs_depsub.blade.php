            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane active" id="tab-eg2-0" role="tabpanel">
                        <p> 
                            <form action="{{ route('t.time_nurs_depsub') }}" method="POST">
                                @csrf
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-2 me-2">  
                                            ...
                                            <a href="{{url('time_nurs_depsubexcel/'.$debsub.'/'.$startdate.'/'.$enddate)}}" class="mb-2 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-success">
