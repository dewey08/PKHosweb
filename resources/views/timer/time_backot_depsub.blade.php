...
@section('title', 'PK-OFFICER || Time-Index')
@section('content')
<style>
    #button{
           display:block;
...
?>
  ...
  <div class="tabs-animation">
    ...
    <form action="{{ route('t.time_backot_depsub') }}" method="POST">
        @csrf
            <div class="row mb-2"> 
                ...
                <div class="col-md-3">    
                    ...
                    <a href="{{url('time_backot_depsubexcel/'.$debsub.'/'.$startdate.'/'.$enddate)}}" class="ladda-button me-2 mb-2 btn-pill btn cardot" style="background-color: rgb(243, 198, 168))">
            ...
            <div class="card-header">
                ...
                <div class="btn-actions-pane-right">
                    <div class="nav">
                        ...
                        <a href="{{ url('time_backot_depsub') }}" class="btn-pill btn-wide me-1 ms-1 active btn btn-outline-alternate btn-sm">กลุ่มงาน/ฝ่าย</a>
