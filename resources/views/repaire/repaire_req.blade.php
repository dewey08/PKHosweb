                ...
                <div class="col-md-12"> 
                    <div class="card shadow">
                        <div class="card-header ">
                            <div class="d-flex">
                                <div class="p-2">
                                    <label for="">ข้อมูลการแจ้งซ่อม</label>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered table-sm myTable "
                                            ...
                                            <tbody>
                                                 <?php $i = 1; ?>
                                                @foreach ($repaire_req as $item)
                                                    <tr id="sid{{ $item->repaire_req_id }}" height="30">
                                                        <td class="text-center" width="3%">{{ $i++ }}</td>

                                                        @if ($item->repaire_req_speed == '1')
                                                            <td class="text-center" width="9%">
                                                                <div class="badge bg-info">ปกติ</div>
                                                            </td>
                                                        @elseif ($item->repaire_req_speed == '2')
                                                            <td class="text-center" width="9%">
                                                                <div class="badge bg-warning">ด่วน</div>
                                                            </td>
                                                        @elseif ($item->repaire_req_speed == '3')
                                                            <td class="text-center" width="9%">
                                                        ...
                                                        <td class="text-center" width="7%">
                                                            {{ dateThai($item->repaire_req_date) }} </td>
                                                        <td class="p-2">{{ $item->repaire_req_detail }}</td>
                                                        <td class="p-2" width="10%">{{ $item->repaire_req_user_name }}
                                                        </td>
                                                        <td class="text-center" width="7%">
                                                            {{ dateThai($item->repaire_req_work_date) }} </td>
                                                        <td class="p-2" width="10%">{{ $item->repaire_req_tec_name }}
                                                        </td>
                                                        <td class="text-center" width="7%">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li>
                                                                        <a class="dropdown-item menu" data-bs-toggle="modal"
                                                                            data-bs-target="#comdetailModal{{ $item->repaire_req_id }}"
                                                                    ...
                                                                    {{-- <li>
                                                                        <a class="dropdown-item menu"
                                                                            href="{{ url('computer/com_staff_index_add/' . $item->repaire_req_id) }}"
                                                                            data-bs-toggle="tooltip"
                                                                    ...
                                                                    <li>
                                                                        <a class="dropdown-item menu"
                                                                            href="{{ url('computer/com_staff_print/' . $item->repaire_req_id) }}"
                                                                            data-bs-toggle="tooltip"
                                                                    ...
                                                                    <li>
                                                                        {{-- <a class="dropdown-item menu"
                                                                            ...
                                                                            onclick="com_staff_cancel({{ $item->repaire_req_id }})"
                                                                            data-bs-toggle="tooltip"
