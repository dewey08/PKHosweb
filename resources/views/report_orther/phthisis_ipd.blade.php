...
@section('title', 'PK-OFFICER || วัณโรค')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form action="{{ url('phthisis_ipd') }}" method="GET">
            @csrf
        <div class="row"> 
            <div class="col"></div>
                    ...
                    <div class="card-body shadow-lg">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <p class="card-title-desc">รายละเอียดวัณโรค IPD แยกตามสิทธิ์</p>
                            </div>
                            <div class="col"></div>
                                ...
                                style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    <thead>
                                        <tr> 
                                            ...
                                            <th class="text-center" >countan</th> 
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i = 1; ?>
                                        @foreach ($phthisis_ipd as $item) 
                                            <tr>                                                  
                                                <td class="text-center" width="5%">{{ $i++ }}</td>   
                                                <td class="text-center" width="5%">{{ $item->pttype }}</td> 
                                                <td class="p-2" >{{ $item->name }}</td> 
                                                <td class="text-center" width="5%">{{ $item->countan }}</td>  
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
