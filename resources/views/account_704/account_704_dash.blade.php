...
<div class="tabs-animation">
    ...
    <div id="preloader">
        ...
        <form action="{{ route('acc.account_704_dash') }}" method="GET">
            @csrf
            <div class="row">
                <div class="col-md-3 ">
                    <h5 class="card-title">Detail 1102050101.704</h5>
                                    ...
                                    <div class="d-flex text-start">
                                        <div class="flex-grow-1 ">
                                            <?php
                                                ...
                                                $datas = DB::select('
                                                    SELECT count(DISTINCT an) as Can
                                                        ...
                                                        from acc_debtor
                                                            WHERE account_code="1102050101.704"
                                                            AND stamp = "N"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col"></div>
                                                <div class="col-md-5 text-end me-2">
                                                    <a href="{{url('account_704_detail/'.$item->months.'/'.$item->years)}}" target="_blank">
                                                        <div class="widget-chart widget-chart-hover">
