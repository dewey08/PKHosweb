                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex">
                                    <div class="p-2">
                                        <label for="">เพิ่มรายการวัสดุ ===>>
                                            {{ $inven->warehouse_inven_name }}</label>
                                    </div>
                                    {{-- <div class="ms-auto">
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <input type="hidden" name="warehouse_rep_id" id="warehouse_rep_id"
                                value="{{ $warehouse_rep->warehouse_rep_id }}">
                            <input type="hidden" name="warehouse_inven_id" id="warehouse_inven_id"
                                value="{{ $inven->warehouse_inven_id }}">

                            <div class="card-body shadow-lg">

                                <table class="table-bordered table-striped table-vcenter" style="width: 100%;">
                                    <thead>
                                        <tr style="background-color: rgb(68, 101, 101);color:#FFFFFF;font-size:14px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control form-control-sm"
                                            style="text-align: right;background-color:#fffec5 ;font-size: 16px;color:red"
                            ...
                            <div class="card-footer">
                                <div class="col-md-12 text-end">
                                    <div class="form-group">
                                        <button type="submit"
                                            class="mb-2 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-primary btn-sm">
                                            <i class="fa-solid fa-floppy-disk me-2"></i>
                                            บันทึกข้อมูล
                                        </button>
                                        <a href="{{ url('warehouse/warehouse_index') }}"
                                            class="mb-2 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-danger btn-sm">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                function addRow() {
                    ...
                    var today = new Date();
                    var date = String(today.getFullYear()).substring(2) + '' + String(today.getMonth() + 1).padStart(2,
                        '0') + '' + String(today.getDate()).padStart(2, '0');
                    var time = String(today.getHours()).padStart(2, '0') + "" + String(today.getMinutes()).padStart(2,
                        '0') + "" + String(today.getSeconds()).padStart(2, '0');;
