                        ...
                        <div class="d-flex">
                            ...
                            <div class="ms-auto">
                                <div class="row">                                   
                                        ...
                                        @if ($warehouse_rep->warehouse_rep_send == 'FINISH' && $countsttus == '0')
                                            <div class="col-md-4">
                                                ...
                                                @else
                                                        ...
                                                        @foreach ($warehouse_repsub as $item)  
                                                                <tr height="30" style="font-size:13px">
                                                                    ...
                                                                    <td>
                                                                        <input name="product_price[]" id="product_price{{$count}}" type="text" class="form-control form-control-sm" value="{{$item->product_price}}" onkeyup="checksummoney(<?php echo $count;?>)">
