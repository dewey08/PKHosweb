    ...
    function warehouse_vendor_destroy(vendor_id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ url('warehouse/warehouse_vendor_destroy') }}" + '/' + vendor_id,
                    type: 'DELETE',
                    data: {
...
<div class="tabs-animation">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="invenModalLabel">เพิ่มตัวแทนจำหน่าย</h5>
    ...
    <div class="modal fade" id="updteinvenModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="invenModalLabel">แก้ไขตัวแทนจำหน่าย</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
