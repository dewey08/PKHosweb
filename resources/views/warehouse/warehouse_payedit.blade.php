        ...
        <script>
            $(document).ready(function() {
                ...
                $('#Updatebtn').click(function() {
                    var editpay_code = $('#pay_code').val();
                    var editwarehouse_pay_id = $('#warehouse_pay_id').val();
                    var editpay_year = $('#pay_year').val();
                    var editpay_payuser_id = $('#pay_payuser_id').val();
                    var editpay_user_id = $('#pay_user_id').val();
                    var editpay_date = $('#pay_date').val();
                    var editpayin_inven_id = $('#payin_inven_id').val();
                    var editpayout_inven_id = $('#payout_inven_id').val();
                    var editstore_id = $('#store_id').val();
                    $.ajax({
