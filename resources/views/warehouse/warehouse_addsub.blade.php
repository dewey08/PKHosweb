...
<body onload="run01();">
    <div class="container-fluid">
        <div class="row">
            <form class="custom-validation" action="{{ route('ware.warehouse_update_addsub') }}" method="POST"
                                ...
                                <div class="card-body shadow-lg">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table-bordered table-striped table-vcenter" style="width: 100%;">
                                            <thead>
                                                <tr
                                                    style="background-color: rgb(103, 182, 182);color:#FFFFFF;font-size:14px">
                                                ...
                                                @else
                                                        ...
                                                        @foreach ($warehouse_repsub_ok as $item)
                                                                <tr height="30" style="font-size:13px">
                                                                    ...
                                                                    <td>
                                                                        <input name="" id="" type="text" class="form-control form-control-sm" value="{{$item->product_qty}}" readonly>
                                                                    </td>
                                                                    ...
                                                                    <td width="10%">
                                                                        <input name="" id="" type="text" class="form-control form-control-sm" value="{{$item->warehouse_rep_sub_exedate}}" readonly>
                                                                    </td>
                                                                    <td width="10%">
                                    ...
                                    <div class="table-responsive">
                                    <label for="">เพิ่มรายการวัสดุ</label>
                                        <table class="table-bordered table-striped table-vcenter" style="width: 100%;">
                                            <thead>
                                                <tr
