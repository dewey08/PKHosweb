    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form action="{{ route('rep.userrequest_report') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col"></div>
    ...
    <div class="modal fade" id="add_report" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('rep.userrequest_report_save') }}" method="POST" id="insert_reportForm"
    ...
    <div class="modal fade" id="updteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('rep.userrequest_report_update') }}" method="POST" id="update_reportForm"
                enctype="multipart/form-data">
                @csrf
