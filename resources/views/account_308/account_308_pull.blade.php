            ...
            <div class="row">
                ...
                <div class="col-md-5 text-end">
                    ...
                    <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy"
                        ...
                        <input type="text" class="form-control inputaccs" name="startdate" id="datepicker" placeholder="Start Date"
                        ...
                        <input type="text" class="form-control inputaccs" name="enddate" placeholder="End Date" id="datepicker2"
                            data-date-container='#datepicker1' autocomplete="off" data-provide="datepicker"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-end">
                                    ...
                                    <button type="button" class="ladda-button me-2 btn-pill btn btn-danger cardacc Destroystamp" data-url="{{url('account_308_destroy_all')}}">
            ...
            $('#Pulldata').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('acc.account_308_pulldata') }}",
                            type: "POST",
                            dataType: 'json',
                            data: {
                                datepicker,
