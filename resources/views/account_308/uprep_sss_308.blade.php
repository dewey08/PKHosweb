...
<script>
    ...
    <div class="tabs-animation p-3 ">
        ...
        <form action="{{ url('uprep_sss_308') }}" method="GET">
            @csrf
            <div class="row"> 
                <div class="col"></div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.editModal', function() {
                var acc_1102050101_308_id = $(this).val(); 
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#editid').val(data.data_show.acc_1102050101_308_id)
                    },
                });
            });
            ...
            $('#Updatedata').click(function() {
                    ...
                    var acc_1102050101_308_id = $('#editid').val();

                    $.ajax({
                        url: "{{ route('acc.uprep_sss_308_update') }}",
                        type: "POST",
                        dataType: 'json',
                        data: {
                            recieve_true,difference,recieve_no,recieve_date,user_id,acc_1102050101_308_id
                        },
                        success: function(data) {
                            if (data.status == 200) {
                                Swal.fire({
