...
<div class="tabs-animation">
    ...
    <form action="{{ url('herb9') }}" method="POST">
            @csrf
    <div class="row"> 
            <div class="col"></div>
            ...
            {{-- <div class="col-md-4">  --}}
                    ...
                    {{-- <a href="{{url('herb9_export')}}" class="btn-icon btn-shadow btn-dashed btn btn-outline-danger">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#Main" role="tab">
                                        ...
                                        <span class="d-none d-sm-block">ยาสมุนไพร 9 ชนิด</span>    
                                    </a>
                                </li>   
                                <li class="nav-item">
                                        ...
                                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr height="20" style="font-size: 12px;">
                                                    ...
                                                    <td class="text-center" width="10%">{{ $item1->debit }}</td>  
                                                </tr>
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, send it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('claim.herb9_send_api') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, send it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('claim.herb9_export_api') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
