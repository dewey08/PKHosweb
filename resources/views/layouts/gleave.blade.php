   ...
   <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <div id="preloader">
        ...
        <div id="layout-wrapper">
            ...
            <div class="topnav" style="background-color:rgb(172, 25, 177) ">
                    ...
                    <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                        ...
                        <div class="collapse navbar-collapse" id="topnav-menu-content">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('gleave_calenda') }}">
                                        <i class="fa-solid fa-calendar-days text-warning me-2"></i> ปฎิทิน
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('gleave_main') }}">
                                        <i class="fa-solid fa-clipboard-list text-info me-2"></i> ตรวจสอบ
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('gleave_config') }}">
                                        <i class="fa-solid fa-clipboard-list text-white me-2"></i> กำหนดการนับวันลา
                                    </a>
                                </li>
