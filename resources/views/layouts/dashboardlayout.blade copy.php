...
<body>
    ...
    $datadetail = DB::connection('mysql')->select('   
                ...
                ');
    ?>
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar Bgheader">
        <div class="app-header header-shadow ">
            <div class="app-header__logo Bgheader"> 
            ...
            <div class="app-header__content Bgheader">
        ...
        <div class="app-main">
            <div class="app-sidebar sidebar-shadow">
                ...
                <div class="scrollbar-sidebar Bgsidebar">
