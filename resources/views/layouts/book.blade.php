...
<body data-topbar="dark">
    ...
    <div id="layout-wrapper">
        ...
        <header id="page-topbar">
            <div class="navbar-header" style="background-color: rgb(110, 10, 168)">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{ url('book/bookmake_index') }}">หนังสือรับ</a></li> 
                                <li><a href="{{ url('book/bookrep_index_add') }}">ออกเลขหนังสือรับ</a></li> 
                        ...
                        {{-- <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                <i class="fa-solid fa-book-open text-danger"></i>
                                <span>ส่งหนังสือ</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{ url('book/bookmake_index') }}">รายละเอียด</a></li> 
                                <li><a href="{{ url('book/bookrep_index_add') }}">ออกเลขหนังสือรับ</a></li> 
