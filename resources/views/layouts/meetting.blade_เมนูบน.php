...
<body data-topbar="light" data-layout="horizontal" style="background-color: rgb(240, 238, 238)">
    ...
    <div id="layout-wrapper">
        ...
        <div class="topnav" style="background-color:rgb(12, 134, 42) ">
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav"> 
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link text-white" href=" " id="topnav-apps"
                                    role="button">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link text-white" href="{{url('meetting/meettingroom_index')}}" id="topnav-apps"
                                    role="button">
                                    <i class="fa-solid fa-house-laptop text-white me-2"></i>รายการห้องประชุม
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link text-white" href="{{url('meetting/meettingroom_check')}}" id="topnav-apps"
                                    role="button">
                                    <i class="fa-solid fa-house-laptop text-danger me-2"></i>ตรวจสอบการจองห้องประชุม
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link text-white" href="{{url('meetting/meettingroom_report')}}" id="topnav-apps"
                                    role="button">
                                    <i class="fa-solid fa-house-laptop text-warning me-2"></i>รายงาน
                                </a> 
                            </li>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
          ...
          // $('#room_list_id').select2({
          //     placeholder:"--เลือก--",
          //     allowClear:true
          // }); 
          // $('#food_list_id').select2({
          //   placeholder:"--เลือก--",
          //     allowClear:true
          // });     
      });
      ...
      $(document).ready(function(){
      $('#insert_roomForm').on('submit',function(e){
        e.preventDefault();
            ...
            if (data.status == 0 ) {
              ...
              Swal.fire({
                ...
                if (result.isConfirmed) {                  
                  window.location="{{url('meetting/meettingroom_index')}}"; 
                }
              })      
            }
          }
      ...
      $('#insert_roomtoolForm').on('submit',function(e){
        e.preventDefault();
      ...
      $('#insert_updatestatusForm').on('submit',function(e){
              e.preventDefault();
                ...
                success:function(data){
                  if (data.status == 0 ) {
                    ...
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {   
                        window.location="{{url('meetting/meettingroom_check')}}"; 
                      }
                    })      
                  }
                }
