                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <h4 style="color:rgb(54, 53, 53)" class="mt-4">PK-OFFICER</h4> 
                            </span>
                        </a>
                    </div>
...
{{-- 
        ...
        <div class="topnav" style="background-color:rgb(139, 76, 223) ">
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav"> 
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="{{url('medical/med_calenda')}}" id="topnav-apps"
                                    role="button">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link " href="{{url('medical/med_index')}}" id="topnav-apps"
                                    role="button">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="{{url('medical/med_borrow')}}" id="topnav-apps"
                                    role="button"><i class="fa-solid fa-file-waveform me-2"></i> 
                                  ยืม-คืน 
                                </a> 
                            </li> 
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-apps"> 
                                    <a href="{{url("medical/med_rep1")}}" class="dropdown-item">สถานะ การยืม/การใช้ (ตามประเภท-หน่วยงาน)</a> 
                                    <a href="{{url("medical/med_rep2")}}" class="dropdown-item">รายงานยืม/การใช้เครื่องมือแพทย์</a> 
                                    <a href="{{url("medical/med_rep3")}}" class="dropdown-item">รายงานยืม/การใช้เครื่องมือแพทย์(ใช้เกินกำหนด(14 วัน))</a>  
                                </div>
