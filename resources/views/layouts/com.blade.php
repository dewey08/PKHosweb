   ...
   <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <div id="preloader">
        ...
        <div id="layout-wrapper">
            ...
            <div class="topnav" style="background-color:rgb(47, 151, 236) ">
                    ...
                    <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                        ...
                        <div class="collapse navbar-collapse" id="topnav-menu-content">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('computer/com_staff_calenda') }}">
                                        <i class="fa-solid fa-calendar-days text-warning me-2"></i> ปฎิทิน
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('computer/com_staff_index') }}">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('computer/com_tech') }}">
                                        <i class="fa-solid fa-hammer text-white me-2"></i> ช่างซ่อมคอมพิวเตอร์
                                    </a>
                                </li>
