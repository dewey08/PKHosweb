    ...
    <div id="layout-wrapper">
        ...
        <header id="page-topbar">
            {{-- <div class="navbar-header shadow-lg" style="background-color: rgb(252, 252, 252)"> --}}
                <div class="navbar-header shadow" style="background-color: rgba(209, 180, 255)">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box" style="background-color: rgb(255, 255, 255)">
                        ...
                        <a href="" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <h4 style="color:rgba(209, 180, 255, 0.781)" class="mt-4">PK-OFFICER</h4>
                            </span>
                        </a>
                    </div>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{ url('prenatal_care') }}">cmi</a></li>
                                {{-- <li><a href="{{ url('prenatal_care') }}" target="_blank">cmi</a></li> --}}
                            </ul>
