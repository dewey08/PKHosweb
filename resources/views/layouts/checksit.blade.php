...
<body data-topbar="dark">
    ...
    <div id="layout-wrapper">
        ...
        <div class="vertical-menu">
            ...
            <div data-simplebar class="h-100" style="background-color: rgb(241, 209, 253)">
                ...
                <div id="sidebar-menu">
                    ...
                    {{-- <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        {{-- <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li > 
                                    <a href="{{ url('check_sit_day') }}" style="color: white">  
                                        เช็คสิทธิ์รายวัน 
                                    </a>
                                    <a href="{{ url('check_sit_money') }}" style="color: white">
                                        เช็คสิทธิ์ Money PK</a>
                                </li>  
                            </ul>
                        </li>  --}}
                        {{-- <li class="mm-active">
