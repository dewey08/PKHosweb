...
<style>
    ...
    .card_sote_2b{
        ...
        box-shadow: 0 0 15px rgb(194, 197, 250);
        border:solid 1px rgba(125, 148, 252);
    }
    .card_sote_4{
    ...
    <div id="layout-wrapper">
        ...
        <header id="page-topbar">
            {{-- <div class="navbar-header shadow-lg" style="background-color: rgb(252, 252, 252)"> --}}
                <div class="navbar-header shadow" style="background-color: rgba(125, 148, 252)">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box" style="background-color: rgb(255, 255, 255)">
                        ...
                        <a href="" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <h4 style="color:rgba(125, 148, 252, 0.781)" class="mt-4">PK-OFFICER</h4>
                            </span>
                        </a>
                    </div>
                    ...
                    <a href="{{url('audiovisual_admin')}}">
                        <h4 style="color:rgb(255, 255, 255)" class="mt-4">AUDIOVISUAL WORK</h4>
                    </a>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                                <i class="fa-solid fa-paintbrush text-success"></i>
                                <span>งานโสต</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{ url('audiovisual_admin') }}" target="_blank">ตรวจสอบ</a></li>
