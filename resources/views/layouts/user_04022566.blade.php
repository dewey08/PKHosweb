...
<body data-topbar="dark" data-layout="horizontal" style="background-color: rgb(240, 238, 238)">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-layout">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-layout-verti">
                                            ...
                                            <a href="{{ url('user/gleave_data_leave') }}" class="dropdown-item"
                                                key="t-compact-sidebar">ยื่นใบลา</a>
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                            id="topnav-layout-hori" role="button">
                                            <span key="t-horizontal">ใบงาน</span>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-layout-hori">
                                            <a href="{{ url('userrequest_report') }}"
                                                class="dropdown-item" key="t-horizontal">ยื่นใบงาน</a> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-layout-hori">
                                            ...
                                            <a href="{{ url('user_car/car_narmal/' . Auth::user()->id) }}"
                                                class="dropdown-item" key="t-topbar-light">ช้อมูลการการใช้รถทั่วไป</a>
                                                <a href="{{ url('user_car/car_ambulance/' . Auth::user()->id) }}"
                                                    class="dropdown-item" key="t-topbar-light">ช้อมูลการการใช้รถพยาบาล</a>
                                        </div>
                                    </div>
    ...
    {{-- <script>
        $(document).ready(function() {
       $('#Update_borrowbtn').on('submit', function(e) {
               e.preventDefault();
               var form = this;
               // alert('OJJJJOL');
               $.ajax({
