...
<link href="https://fonts.googleapis.com/css2?family=Srisakdi&display=swap" rel="stylesheet"> --}}
    ...
    <link rel="stylesheet" href="{{ asset('css/clinictb.css') }}">
    ...
    <div id="layout-wrapper">
        ...
        <header id="page-topbar">
            {{-- <div class="navbar-header shadow-lg" style="background-color: rgb(252, 252, 252)"> --}}
                <div class="navbar-header shadow" style="background-color: rgba(93, 199, 241, 0.74)">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box" style="background-color: rgb(255, 255, 255)">
                        <a href="" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                ...
                                <h4 style="color:rgba(93, 199, 241, 0.74)" class="mt-4">PK-OFFICER</h4>
                            </span>
                        </a>
                    ...
                    <a href="{{url('report_db')}}">
                        <h4 style="color:rgb(255, 255, 255)" class="mt-4">CLINIC TB</h4>
                    </a>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true"> 
                                <li><a href="{{ url('tb_main') }}" >บริการคัดกรองและค้นหาวัณโรคในกลุ่มเสี่ยง</a> </li>
