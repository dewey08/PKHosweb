...
<body data-topbar="light" data-layout="horizontal">
    ...
    <div id="layout-wrapper">
        ...
        <div class="topnav" style="background-color: rgba(139, 3, 117, 0.952)">
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link " href="{{url('person/person_index')}}" id="topnav-apps"
                                    role="button">
                                    <i class="fa-solid fa-user-tie text-info me-2"></i>ข้อมูลบุคลากร
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link " href="" id="topnav-apps"
                                    role="button">
                                    <i class="ri-apps-2-line text-warning me-2"></i>ประชุมภายนอก
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link " href="" id="topnav-apps"
                                    role="button">
                                    <i class="ri-apps-2-line text-danger me-2"></i>ประชุมภายใน
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-apps"> 
                                    ...
                                    <a href="{{url("report_dep")}}" class="dropdown-item">เลือกตามกลุ่มภารกิจ</a> 
