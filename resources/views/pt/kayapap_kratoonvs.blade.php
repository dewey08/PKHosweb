                ...
                <div class="card-body py-0 px-2 mt-2">
                    <div class="table-responsive">
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap myTable"
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                @foreach ($kayapap_kratoonvs as $item)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('kayapap_kratoonvs_sub/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->VN}}</a>  
                                        </td>
                                        <td class="text-center">
                                            <a href="{{url('kayapap_kratoonvs_spsch/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->spsch}}</a>  
                                        </td>
                                        <td class="text-center">
                                            <a href="{{url('kayapap_kratoonvs_nokey/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->nokey}}</a>  
                                        </td>
