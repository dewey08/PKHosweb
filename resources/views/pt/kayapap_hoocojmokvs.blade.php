...
@section('content')
    ...
    <div class="row mt-3">
        <div class="col-xl-12">
            <h5>รายงานจำนวนผู้ป่วยนอกที่ได้รับให้บริการฟื้นฟู(Ear)</h5>
            <div class="card">
                <div class="card-body py-0 px-2 mt-2">
                    <div class="table-responsive">
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap myTable"
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                @foreach ($kayapap_hoocojmokvs as $item)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('kayapap_hoocojmokvs_vs/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->VN}}</a>  
                                        </td>
                                        <td class="text-center">
                                            <a href="{{url('kayapap_hoocojmokvs_spsch/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->spsch}}</a>  
                                        </td>
                                        <td class="text-center">
                                            <a href="{{url('kayapap_hoocojmokvs_nokey/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->nokey}}</a> 
                                         </td>
