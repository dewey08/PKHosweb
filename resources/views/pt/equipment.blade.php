...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <form action="{{ route('pt.equipment') }}" method="POST">
                    @csrf
                    <div class="row">
    ...
    <div class="row mt-3">
        <div class="col-xl-12">
            <h5>รายงานจำนวนผู้ป่วยนอกที่ได้รับกายอุปกรณ์</h5>
            <div class="card">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap myTable"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"> {{$item->HN}} 
                                    </td>
                                    <td class="text-center" width="12%">
                                        <a href="{{url('equipment_vn/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->VN}}</a>  
                                    </td>
                                    <td class="text-center" width="12%">
                                        <a href="{{url('equipment_spsch/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->spsch}}</a>  
                                    </td>
                                    <td class="text-center" width="12%">
                                        <a href="{{url('equipment_nokey/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->nokey}}</a> 
                                    </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{$item2->payclaim}}</td>
