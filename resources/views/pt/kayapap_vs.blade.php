                                ...
                                @foreach ($kayapap_vs as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('kayapap_vs_sub/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->VN}}</a>  
                                        </td>
                                        <td class="text-center">
                                            <a href="{{url('kayapap_vs_spsch/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->spsch}}</a>  
                                        </td>
                                        <td class="text-center">
                                            <a href="{{url('kayapap_vs_nokey/'.$item->months.'/'.$startdate.'/'.$enddate)}}" target="_blank">{{$item->nokey}}</a>  
                                        </td>
