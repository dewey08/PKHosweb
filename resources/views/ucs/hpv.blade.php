...
<div class="tabs-animation">
    ...
    <form action="{{ url('hpv') }}" method="POST">
        @csrf
    <div class="row"> 
            <div class="col-md-3">
            ...
            <div class="col-md-1 text-start"> 
                <button type="button" class="btn-icon btn-shadow btn-dashed btn btn-outline-success card_fdh_4 Claim_vn" data-url="{{url('hpv_process_vn')}}">
