...
<div class="tabs-animation">
    ...
    <form action="{{ url('ucep24_main') }}" method="POST">
        @csrf
    <div class="row"> 
            <div class="col-md-3">
                <h4 class="card-title" style="color:rgba(21, 177, 164, 0.871)">Detail UCEP-24 List</h4>
                <p class="card-title-desc">รายละเอียดข้อมูล UCEP-24</p>
            </div>
            <div class="col"></div>
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#Main" role="tab">
                                        ...
                                        <span class="d-none d-sm-block">UCEP24</span>    
                                    </a>
                                </li>   
                                <li class="nav-item">
