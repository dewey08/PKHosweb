...
<div class="tabs-animation">
    ...
    <form action="{{ url('fdh_ppfs_12001') }}" method="POST">
        @csrf
    <div class="row"> 
            <div class="col-md-4">
                <h4 class="card-title" style="color:rgba(21, 177, 164, 0.871)">Detail 12001 List</h4>
            ...
            <div class="col-md-5 text-end">
                <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker1'>
                    ...
                    <button type="button" class="btn-icon btn-shadow btn-dashed btn btn-outline-success card_fdh_4 Claim" data-url="{{url('fdh_ppfs_12001_process')}}">
                        <i class="fa-solid fa-spinner text-success me-2"></i>
                        ส่งเคลม
                    </button>
                   
                    <a href="{{url('fdh_ppfs_12001_export')}}" class="btn-icon btn-shadow btn-dashed btn btn-outline-danger card_fdh_4">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $number++; ?>
                                                    ...
                                                    <tr height="20" style="font-size: 12px;">
                                                        ...
                                                        @else
                                                            <td class="text-center" width="5%"><input type="checkbox" class="fdhcheckbox sub_chk" data-id="{{$item->d_12001_id}}"> </td> 
                                                        @endif
