...
<div class="tabs-animation">
    ...
    <form action="{{ url('liquid') }}" method="POST">
        @csrf
    <div class="row"> 
            <div class="col-md-3">
                <h4 class="card-title" style="color:rgba(21, 177, 164, 0.871)">Detail hpv List</h4>
                <p class="card-title-desc">รายละเอียดข้อมูล hpv List</p>
            </div>
            ...
            <div class="col-md-1 text-start"> 
                <button type="button" class="btn-icon btn-shadow btn-dashed btn btn-outline-success card_fdh_4 Claim_vn" data-url="{{url('liquid_process_vn')}}">
            ...
            <div class="col-md-5 text-end">
                <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker1'>
                    ...
                    <button type="button" class="btn-icon btn-shadow btn-dashed btn btn-outline-success card_fdh_4 Claim" data-url="{{url('liquid_process')}}"> 
                         <i class="fa-solid fa-2 text-success me-2"></i>
                        ส่งเคลม
                    </button>
                   
                    <a href="{{url('liquid_export')}}" class="btn-icon btn-shadow btn-dashed btn btn-outline-danger card_fdh_4"> 
                        <i class="fa-solid fa-3 text-danger me-2"></i>
                        Export Txt
                    </a> 
                    <a href="{{url('liquid_zip')}}" class="btn-icon btn-shadow btn-dashed btn btn-outline-primary card_fdh_4"> 
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#Main" role="tab">
                                        ...
                                        <span class="d-none d-sm-block">HPV</span>    
                                    </a>
                                </li>   
                                <li class="nav-item">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $number++; ?>
                                                    ...
                                                    <tr height="20" style="font-size: 12px;">
                                                        ...
                                                        @if ($item->authen == '')
                                                            <td class="text-center" width="7%" style="background-color: rgb(189, 143, 248)">{{ $item->authen }}</td> 
                                                        @else
                                                        ...
                                                        <td class="text-center" width="5%">{{ $item->nhso_adp_code }}</td> 
