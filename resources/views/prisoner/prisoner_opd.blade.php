...
@section('title', 'PK-OFFICER || Prisoner')
...
@section('content')
   ...
   <div class="tabs-animation">
        ...
        <form action="{{ route('prisoner.prisoner_opd') }}" method="GET">
            @csrf
            <div class="row"> 
                <div class="col-md-4">
                    <h4 class="card-title">Detail Prisoner</h4>
                    <p class="card-title-desc">รายละเอียดข้อมูลนักโทษที่มารักษา OPD บ้านเลขที่ 438</p>
                </div>
                <div class="col"></div>
