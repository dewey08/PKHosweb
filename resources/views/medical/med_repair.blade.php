 ...
 ?>
    <div class="px-3 py-2 border-bottom">
        <div class="container d-flex flex-wrap justify-content-center">
            ...
            <a href="{{ url('medical/med_dashboard') }}" class="btn btn-light btn-sm text-dark me-2">dashboard  </a>
            <a href="{{ url('medical/med_index') }}" class="btn btn-light btn-sm text-dark me-2">ทะเบียนครุภัณฑ์เครื่องมือแพทย์ <span class="badge bg-danger ms-2">{{$count_meettingroom}}</span></a>
            <a href="{{ url('medical/med_repair') }}" class="btn btn-warning btn-sm text-white me-2">ทะเบียนซ่อมเครื่องมือแพทย์ <span class="badge bg-danger ms-2">{{$count_meettingroom}}</span></a>
            <a href="{{ url('medical/med_report') }}" class="col-4 col-lg-auto mb-2 mb-lg-0 me-lg-auto btn btn-light btn-sm text-dark me-2">รายงาน</a>
