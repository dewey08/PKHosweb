                            ...
                            <tbody>
                                ...
                                @foreach ($medical_borrow as $item)
                                    ...
                                    <tr id="sid{{ $item->medical_borrow_id }}">
                                        ...
                                        <td width="10%" class="text-center" style="font-size: 13px"> {{ DateThai($item->medical_borrow_date )}}</td>
                                        <td width="10%" class="text-center" style="font-size: 13px">{{ DateThai($item->medical_borrow_backdate) }}</td>
                                        <td width="15%" class="p-2" style="font-size: 13px">{{ $item->article_num }}</td>
                                        ...
                                        <td class="text-center" width="7%">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <button type="button"
                                                    class="dropdown-item menu btn btn-outline-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editborrowdata{{ $item->medical_borrow_id }}"
                                                ...
                                                <li>
                                                    ...
                                                    <a class="dropdown-item menu btn btn-outline-primary btn-sm editData" value="{{$item->medical_borrow_id}}" data-bs-toggle="tooltip"
                                                        data-bs-toggle="custom-tooltip" data-bs-placement="left" title="ส่งคืน">
                                     ...
                                     <!--  Modal content for the editborrowdata example -->
                                    <div class="modal fade " id="editborrowdata{{ $item->medical_borrow_id }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="myExtraLargeModalLabel">แก้ไขทะเบียนยืม</h5>
                                                ...
                                                <div class="modal-footer">
                                                    <div class="col-md-12 text-end">
                                                        <div class="form-group">
                                                            <button type="button" id="UpdateDatabtn" class="btn btn-primary btn-sm">
