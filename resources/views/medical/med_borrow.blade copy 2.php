                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="custom-validation" action="{{ route('med.med_borrowDataupdate') }}" method="POST" id="Med_Dataupdate_medForm" enctype="multipart/form-data">
                                                    @csrf
                                                ...
                                                <input type="hidden" id="edit_medical_borrow_users_id"
                                                    name="medical_borrow_users_id" value="{{ $iduser }}">
                                                <input type="hidden" id="edit_medical_borrow_id"
                                                    name="medical_borrow_id" value="{{ $item->medical_borrow_id }}">
...
@section('footer')
    ...
    <script>
        ...
        //     });
        // });
        // $('#med_borrowDataupdate_medForm').on('submit', function(e) {
        //         e.preventDefault();
