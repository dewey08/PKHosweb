            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"> 
                        <div class="d-flex">
                            <div class="">
                                <label for="">แก้ไขข้อมูลครุภัณฑ์เครื่องมือแพทย์</label>
                            </div>
                            <div class="ms-auto">
                                <form class="custom-validation" action="{{ route('med.med_update') }}" method="POST"
                                id="update_medForm" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input id="article_recieve_date" type="date" class="form-control form-control-sm" value="{{$dataedits->article_recieve_date}}"
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input id="article_num" type="text" class="form-control form-control-sm" value="{{$dataedits->article_num}}"
                                                    name="article_num">
                                            </div>
                                        </div>
                                        <div class="col-md-2 text-end">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input id="article_name" type="text" class="form-control form-control-sm" value="{{$dataedits->article_name}}"
                                                    name="article_name">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="form-group">
                                                <input id="article_attribute" type="text" class="form-control form-control-sm" value="{{$dataedits->article_attribute}}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <select id="medical_typecat_id" name="medical_typecat_id"
                                                    ...
                                                    @if ($dataedits->medical_typecat_id == $typecat->medical_typecat_id)
                                    ...
                                    <div class="row mt-3"> 
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input id="article_price" type="text" class="form-control form-control-sm" value="{{$dataedits->article_price}}"
                                                    name="article_price">
                                            </div>
                                        </div>
                                        <div class="col-md-1">
