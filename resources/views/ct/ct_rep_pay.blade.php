...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ url('ct_rep_pay') }}" method="POST">
            @csrf
        <div class="row"> 
            <div class="col-md-2"> 
                <h4 class="card-title" style="color:rgb(10, 151, 85)">Detail CT Confirm</h4>
                <p class="card-title-desc">รายละเอียด CT ที่ผ่านการตรวจสอบแล้ว</p>
            </div>
            <div class="col"></div>
