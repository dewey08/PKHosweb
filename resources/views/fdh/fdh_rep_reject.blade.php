            ...
            <div class="col-xl-8 col-md-6">
                <div class="card card_fdh_4">
                    <div class="grid-menu-col">
                        <form action="{{ route('fdh.fdh_rep_reject_save') }}" method="POST" enctype="multipart/form-data"> 
                            @csrf
                            <div class="row">
                                <div class="col"></div>
                                <div class="col-md-8">
                                    ...
                                    @if ($countc > 0)
                                        <a href="{{ url('fdh_rep_reject_send') }}" class="mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-primary">
                                ...
                                @foreach ($datashow as $item)
                                    <?php $number++; ?>
                                        ...
                                        <tr height="20" style="font-size: 14px;color:rgb(235, 6, 6)">
                                            ...
                                            <td class="text-end" style="color:rgb(248, 12, 12)" width="7%"> {{ $item->hn }}</td>
                                            <td class="text-end" style="color:rgb(248, 12, 12)" width="7%"> {{ $item->vn }}</td>
                                            <td class="text-end" style="color:rgb(248, 12, 12)" width="7%"> {{ $item->an }}</td>
                    ...
                    if (data.status == 100) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location = "{{ url('fdh_rep_reject') }}";
                            }
                        })
                    }
