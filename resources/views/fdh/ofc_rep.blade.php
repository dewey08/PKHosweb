            ...
            <div class="col-xl-8 col-md-6">
                <div class="card card_fdh_4">
                    <div class="grid-menu-col">
                        <form action="{{ route('fdh.ofc_rep_save') }}" method="POST" enctype="multipart/form-data"> 
                            @csrf
                            <div class="row">
                                <div class="col"></div>
                                <div class="col-md-8">
                                    ...
                                    @if ($countc > 0)
                                        <a href="{{ url('ofc_rep_send') }}" class="mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-primary">
