            ...
            <div class="col-xl-8 col-md-6">
                <div class="card card_fdh_4">
                    <div class="grid-menu-col">
                        <form action="{{ route('fdh.fdh_rep_save') }}" method="POST" enctype="multipart/form-data"> 
                            @csrf
                            <div class="row">
                                <div class="col"></div>
                                <div class="col-md-8">
                                    ...
                                    @if ($countc > 0)
                                        <a href="{{ url('fdh_rep_send') }}" class="mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-primary">
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;color:rgb(235, 6, 6)">
                                        ...
                                        {{-- <td class="text-center" width="10%" style="color:rgb(248, 12, 12)"> {{ $item->A }}</td> --}}
                                        @if ($item->months == '1')
