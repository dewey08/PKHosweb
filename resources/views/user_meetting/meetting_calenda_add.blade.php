                            ...
                            <div class="col-lg-9 mb-5">
                                <div class="card bg-info p-1 mx-0">
                                    ...
                                    <div class="panel-footer text-end bg-white mb-5">
                                        <p class="m-0 fa fa-circle me-2 mt-5 mb-5" style="color:#A3DCA6;"></p> อนุมัติ<label
                                            class="me-3"></label>
                                        <p class="m-0 fa fa-circle me-2 mt-5 mb-5" style="color:#814ef7;"></p> จัดสรร<label
                                            class="me-3"></label>
                                        <p class="m-0 fa fa-circle me-2 mt-5 mb-5" style="color:#fa861a;"></p>ร้องขอ <label
                                            class="me-5"></label>
                                    </div>
                                </div>
                            </div>
