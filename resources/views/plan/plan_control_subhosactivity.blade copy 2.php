        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">กิจกรรมสำคัญ</h4>
    
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">กิจกรรมสำคัญ</a></li>
                            ...
                            <div class="col-md-12"> 
                                <form action="{{ route('p.plan_control_activity_save') }}" id="Insert_data" method="POST">
                                    ...
                                    <div class="card-body">  
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <h4 class="card-title">กิจกรรมสำคัญ</h4>
                                                </div>
                                                <div class="col"></div>
                                                <div class="col-md-2">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card cardplan">  
                    ...
                    <div class="card-body"> 
                        <div class="row mb-2">
                            <div class="col-md-8 text-start"> <h5 class="modal-title me-3" id="editModalLabel">กิจกรรมสำคัญ  {{$plan_control->plan_name}} เลขที่ {{$plan_control->billno}}</h5>  </div>
                            {{-- <div class="col"></div> --}}
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                <thead >
                                    <tr style="font-size: 13px;background-color: rgb(255, 231, 226);border-color: rgb(183, 180, 180)">
                                        ...
                                        <th rowspan="3" colspan="1" class="text-center" style="border-color: rgb(183, 180, 180)"> กิจกรรมสำคัญ</th> 
                                            ...
                                            <td class="text-start" width="15%">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                            ...
                                                            <a type="button" href="{{url('plan_control_activity_edit/'.$id.'/'.$plan_control->plan_control_id.'/'.$item_->plan_control_activity_id)}}"
