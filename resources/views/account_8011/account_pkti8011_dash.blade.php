    ...
    <div id="preloader">
        ...
        <form action="{{ url('account_pkti8011_dash') }}" method="GET">
            ...
            <div class="row "> 
                ...
                <div class="col-md-3"> 
                    <h4 class="card-title" style="color:rgb(10, 151, 85)">Detail 1102050102.8011</h4>
                                    ...
                                    <div class="d-flex text-start">
                                        <div class="flex-grow-1 ">
                                            ...
                                            $sumapprove_ = DB::select('
                                                    SELECT sum(am.pay_amount) as pay_amount,count(DISTINCT a.vn) as Countvisit
                                                        from acc_1102050102_8011 a
                                                        LEFT JOIN acc_stm_lgoti am on am.cid = a.cid AND am.vstdate = a.vstdate
                                                        where month(a.vstdate) = "'.$item->months.'"
                                                        AND year(a.vstdate) = "'.$item->year.'"
                                                        AND pay_amount IS NOT NULL
                                                ');                                           
                                                foreach ($sumapprove_ as $key => $value3) {
                                                    $sum_stm = $value3->pay_amount; 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 text-end mt-2 me-4">
                                                    <a href="{{url('account_pkti8011_pull')}}" target="_blank">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col"></div>
                                                <div class="col-md-5 text-end me-4">
                                                    <a href="{{url('account_pkti8011_detail/'.$item->months.'/'.$item->year)}}" target="_blank">
                                                        <div class="widget-chart widget-chart-hover">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col"></div>
                                                <div class="col-md-5 text-end me-4">
                                                    <a href="{{url('account_pkti8011_stm/'.$item->months.'/'.$item->year)}}" target="_blank">
                                                        <div class="widget-chart widget-chart-hover">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col"></div>
                                                <div class="col-md-5 text-end me-4"> 
                                                    <a href="{{url('account_pkti8011_stmnull/'.$item->months.'/'.$item->year)}}" target="_blank">
                                                        <div class="widget-chart widget-chart-hover">
                                ...
                                <div class="d-flex text-start">
                                    <div class="flex-grow-1 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col"></div>
                                            <div class="col-md-5 text-end me-4">
                                                <a href="{{url('account_pkti8011_detail_date/'.$startdate.'/'.$enddate)}}" target="_blank">
                                                    <div class="widget-chart widget-chart-hover">
                                                        <p class="text-end mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="ตั้งลูกหนี้ {{$count_Y}} Visit">
                                                                {{ number_format($sum_Y, 2) }}
                                                                <i class="fa-brands fa-btc text-danger ms-2"></i>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col"></div>
                                            <div class="col-md-5 text-end me-4">
                                                <a href="{{url('account_pkti8011_stm_date/'.$startdate.'/'.$enddate)}}" target="_blank">
                                                    <div class="widget-chart widget-chart-hover">
                                                        <p class="text-end mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Statement {{$count_stm}} Visit">
                                                            {{ number_format($sum_stm, 2) }} 
                                                                <i class="fa-brands fa-btc text-success ms-2"></i>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col"></div>
                                            <div class="col-md-5 text-end me-4"> 
                                                <a href="{{url('account_pkti8011_stmnull_date/'.$startdate.'/'.$enddate)}}" target="_blank">
                                                    <div class="widget-chart widget-chart-hover">
                                                        <p class="text-end mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="ยกยอดไปเดือนนี้ {{$count_yokpai}} Visit" >
                                                        {{ number_format($sum_yokpai, 2) }}  
                                                        <i class="fa-brands fa-btc ms-2" style="color: rgb(160, 12, 98)"></i>
