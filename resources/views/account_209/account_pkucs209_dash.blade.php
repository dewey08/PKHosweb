...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ route('acc.account_pkucs209_dash') }}" method="GET">
            ...
            <div class="row">
                <div class="col-md-4">
                    <h4 class="card-title">Detail 1102050101.209</h4>
                                            ...
                                            <div class="flex-grow-1 ">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1 text-start ms-4">
                                                        <i
                                                            class="fa-solid fa-2x fa-sack-dollar me-2 align-middle text-secondary"></i>
                                                    </div>
                                                    ...
                                                    <div class="col-md-5 text-end me-2">
                                                        {{-- <a href="" target="_blank"> --}}
                                                        <div class="widget-chart widget-chart-hover">
                                                            <p class="text-end mb-0" data-bs-toggle="tooltip"
                                                                data-bs-placement="top"
                                                                title="ลูกหนี้ที่ต้องตั้ง {{ $count_N }} Visit">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1 text-start ms-4">
                                                        <i
                                                            class="fa-brands fa-2x fa-bitcoin me-2 align-middle text-danger"></i>
                                                    </div>
                                                    <div class="col-md-4 text-start mt-3">
                                                        <p class="text-muted mb-0">
                                                            ตั้งลูกหนี้
                                                    ...
                                                    <div class="col"></div>
                                                    <div class="col-md-5 text-end me-2">
                                                        <a href="{{ url('account_pkucs209_detail/' . $item->months . '/' . $item->year) }}"
                                                            target="_blank">
                                                            <div class="widget-chart widget-chart-hover">
                                                                <p class="text-end mb-0" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top"
                                                                    title="ตั้งลูกหนี้ {{ $count_Y }} Visit">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1 text-start ms-4">
                                                        <i
                                                            class="fa-brands fa-2x fa-bitcoin me-2 align-middle text-success"></i>
                                                    </div>
                                                    <div class="col-md-4 text-start mt-3">
                                                        <p class="text-muted mb-0">
                                                            Statement
                                                    ...
                                                    <div class="col"></div>
                                                    <div class="col-md-5 text-end me-2">
                                                        {{-- <a href="{{url('account_pkucs209_stm/'.$item->months.'/'.$item->year)}}" target="_blank"> --}}
                                                        <div class="widget-chart widget-chart-hover">
                                                            {{-- {{$stm_count}} --}}
                                                            <p class="text-end mb-0" data-bs-toggle="tooltip"
                                                                data-bs-placement="top" title="Statement Visit">
                                                                {{-- {{ number_format($amountpay, 2) }} --}}0.00
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1 text-start ms-4">
                                                        <i class="fa-brands fa-2x fa-bitcoin me-2 align-middle"
                                                            style="color: rgb(160, 12, 98)"></i>
                                                    </div>
                                                    <div class="col-md-4 text-start mt-3">
                                                        <p class="text-muted mb-0">
                                                            ยกยอดไปเดือนนี้
                                                    ...
                                                    <div class="col"></div>
                                                    <div class="col-md-5 text-end me-2">
                                                        {{-- <a href="{{url('account_pkucs209_stmnull/'.$item->months.'/'.$item->year)}}" target="_blank"> --}}
                                                        <div class="widget-chart widget-chart-hover">
                                                            {{-- {{$count_yokma_all}} --}}
                                                            <p class="text-end mb-0" data-bs-toggle="tooltip"
                                                                data-bs-placement="top" title="Statement  Visit">
                                                                {{-- {{ number_format($total_yokma_all, 2) }} --}}0.00
                                                                <i class="fa-brands fa-btc ms-2"
                                                                    style="color: rgb(160, 12, 98)"></i>
                                                            </p>
                                                        </div>
                                                        {{-- </a> --}}
                                        ...
                                        <div class="d-flex text-start">
                                            <div class="flex-grow-1 ">
                                                ...
                                                $datas = DB::select(
                                                    '
                                                                                                SELECT count(DISTINCT vn) as Can
                                                                                                    ...
                                                                                                    from acc_debtor
                                                                                                        WHERE account_code="1102050101.209"
                                                                                                        AND stamp = "N" AND vstdate BETWEEN "' .
                                                        $startdate .
                                                        '" and "' .
                                                        $startdate .
                                                        '" 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col"></div>
                                                    <div class="col-md-5 text-end me-2">
                                                        <a href="{{ url('account_pkucs209_detail_date/' . $startdate . '/' . $enddate) }}"
                                                            target="_blank">
                                                            <div class="widget-chart widget-chart-hover">
                                                                <p class="text-end mb-0" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top"
