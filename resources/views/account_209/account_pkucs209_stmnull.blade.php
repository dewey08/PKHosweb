            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-header"> 
                       รายละเอียดตั้งลูกหนี้ผัง 1102050101.209 ยกยอดไป
                    ...
                    <div class="card-body">  
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Stm 209</th> 
                                ...
                                @foreach ($data as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        <td class="text-center" width="8%">{{ $item->vn }}</td> 
                                                ...
                                                <td class="text-end" style="color:rgb(184, 12, 169)" width="7%">{{ number_format(($item->pp),2)}}</td> 
