...
<div class="tabs-animation">
    ...
    <form action="{{ url('crrt') }}" method="POST">
        @csrf
    <div class="row"> 
            <div class="col-md-3">
                <h4 class="card-title" style="color:rgb(252, 161, 119)">Detail Crrt List</h4>
                <p class="card-title-desc">รายละเอียดข้อมูล Crrt List</p>
            </div>
            <div class="col"></div>
            ...
            <div class="col-md-7 text-end">
                <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker1'>
                    ...
                    <button type="button" class="btn-icon btn-shadow btn-dashed btn btn-outline-success" id="Processdata">
                        ...
                        <a href="{{url('crrt_export')}}" class="btn-icon btn-shadow btn-dashed btn btn-outline-danger">
                                        ...
                                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr height="20" style="font-size: 12px;">
                                                    ...
                                                    {{-- <td class="text-center" width="7%">{{ $item1->authen }}</td>  --}}
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, send it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('claim.crrt_exportapi') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
