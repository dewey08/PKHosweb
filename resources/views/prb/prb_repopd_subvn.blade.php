                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">ค่ารักษาที่ต้องชำระ</th>
                                    <th class="text-center">ค่ารักษาลูกหนี้</th>
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                @foreach ($data_repopdsubvn as $item)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td>{{$item->vn}}</td> 
                                        <td>{{$item->cid}}</td> 
                                        ...
                                        <td>
                                            <a href="{{url('prb_repopd_subsubvn/'.$item->vn)}}" target="_blank">{{ $item->income }}</a>  
                                        </td>
