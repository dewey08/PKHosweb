...
@section('content')
    <script>
        ...
        function acc_310_destroy(acc_debtor_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('acc_310_destroy') }}" + '/' + acc_debtor_id,
                        type: 'POST',
                        data: {
    ...
    <div class="tabs-animation">
        ...
        <div class="row"> 
            <div class="col-md-4">
                <h4 class="card-title" style="color:rgb(10, 151, 85)">Detail Account ผัง 1102050101.310</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 text-end">
                                ...
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-primary cardacc Savestamp" data-url="{{url('account_310_stam')}}">
                                    <i class="fa-solid fa-file-waveform me-2"></i>
                                    ตั้งลูกหนี้
                                </button>
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-danger cardacc Destroystamp" data-url="{{url('account_310_destroy_all')}}">
                                ...
                                style=" border-spacing: 0; width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            {{-- <th width="5%" class="text-center"> <i class="fa-solid fa-2x fa-trash-can text-danger"></i>  </th>  --}}
                                            ...
                                            <tr id="sid{{$item->acc_debtor_id}}">                                                  
                                                ...
                                                {{-- <td>
                                                    <a class="dropdown-item menu text-danger" href="javascript:void(0)"
                                                            onclick="acc_310_destroy({{ $item->acc_debtor_id }})"
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, pull it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('acc.account_310_pulldata') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
            ...
            $('#Check_sit').click(function() {
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, pull it!'
                            ...
                            $.ajax({
                                url: "{{ route('acc.account_310_checksit') }}",
                                type: "POST",
                                dataType: 'json',
                                data: {
                                    datepicker,
