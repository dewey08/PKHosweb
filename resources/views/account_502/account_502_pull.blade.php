...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <div class="row"> 
            <div class="col-md-4">
                <h5 class="card-title" style="color:rgb(10, 151, 85)">Detail 1102050101.502</h5>
                    ...
                    <div class="card-body">
                        ...
                        {{-- <div class="row">
                            ...
                            <div class="col-md-2 text-end">
                                <button type="button" class="mb-2 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-info Savestamp" data-url="{{url('account_502_stam')}}">
                        ...
                        <div class="row mb-3"> 
                            <div class="col"></div>
                            <div class="col-md-2 text-end">
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-primary cardacc Savestamp" data-url="{{url('account_502_stam')}}">
                                    <i class="fa-solid fa-file-waveform me-2"></i>
                                    ตั้งลูกหนี้
                                </button>
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-danger cardacc Destroystamp" data-url="{{url('account_502_destroy')}}">
                ...
                Swal.fire({
                        ...
                        confirmButtonText: 'Yes, pull it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('acc.account_502_pulldata') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
