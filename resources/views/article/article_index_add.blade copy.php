...
@section('title', 'PK-OFFICER || ข้อมูลครุภัณฑ์')
                            ...
                            <div class="ms-auto">
                                <form class="custom-validation" action="{{ route('art.article_index_save') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="article_yes"
                                                    id="article_claim" value="YES" >
                                                <label class="form-check-label" for="article_yes">
                                                    ใช้บ่อย
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="article_used"
                                                    id="article_claim" value="NO" checked>
