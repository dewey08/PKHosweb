                                    ...
                                    @foreach ($datashow as $item2)
                                        <tr id="sid{{ $item2->account_main_id }}">
                                            ...
                                            <td width="3%" class="text-center">
                                                    <button type="button" class="btn btn-outline-warning editData" value="{{ $item2->account_main_id }}">
                ...
                <div class="row">
                     <div class="col-md-2">
                         ...
                         <div class="form-group mt-2">
                             <input type="text" name="acc" id="editacc" class="form-control form-control-sm">
                         </div>
                     </div>
                     <div class="col-md-2 ">
                         <label for="">เงินเดือน</label>
                         <div class="form-group mt-2 ">
                            <input type="text" name="salary" id="editsalary" class="form-control form-control-sm text-end">
                         </div>
                     </div>
                     <div class="col-md-2">
                         <label for="">ตกเบิก</label>
                         <div class="form-group mt-2">
                            <input type="text" name="backpay" id="editbackpay" class="form-control form-control-sm text-end">
                         </div>
                     </div>
                     <div class="col-md-2">
                        <label for="">ปจต</label>
                        <div class="form-group mt-2">
                           <input type="text" name="positionpay" id="editpositionpay" class="form-control form-control-sm text-end">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <label for="">8-11</label>
                        <div class="form-group mt-2">
                           <input type="text" name="a0811" id="edita0811" class="form-control form-control-sm text-end">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <label for="">ครองชีพ</label>
                        <div class="form-group mt-2">
                           <input type="text" name="cost_of_living" id="editcost_of_living" class="form-control form-control-sm text-end">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <label for="">2%4%</label>
                        <div class="form-group mt-2">
                            <input type="text" name="a24percent" id="edita24percent" class="form-control form-control-sm text-end">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <label for="">OT</label>
                        <div class="form-group mt-2 ">
                           <input type="text" name="ot" id="editot" class="form-control form-control-sm text-end">
                        </div>
                    </div>  
                </div>
