                ...
                <div class="card shadow">
                    ...
                    {{-- <div class="card-header ">
                        <div class="row">
                            ...
                            <div class="col-md-4 ">
                               <button type="button" class="btn ms-3 text-danger" style="background-color: rgb(236, 232, 181)">ลงบัญชีรับ</button>
                               <button type="button" class="btn ms-3 text-danger" style="background-color: rgb(200, 233, 248)">เช็คบัญชีรับ</button>
                               <button type="button" class="btn ms-3 text-danger" style="background-color: rgb(232, 208, 255)">ลงบัญชีรับสำเร็จ</button>
                           </div>
                                            ...
                                            <tr id="sid{{ $item2->account_main_id }}" style="{{ $color_new }}">
                                                ...
                                                <td width="5%" class="text-center">
                                                    ...
                                                    @if ($item2->account_rep_active == 'CHECK')
                                                        <button type="button" class="btn btn-light btn-sm shadow changstatus"
                                                    ...
                                                    @elseif ($item2->account_rep_active == 'TAKEDOWN')
                                                        {{-- status = TAKEDOWN --}}
                                                        <button type="button" class="btn btn-warning btn-sm shadow editData2"
                                                            value="{{ $item2->account_main_id }}"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-custom-class="custom-tooltip"
                                                            data-bs-title="เช็คการลงข้อมูลบัญชีรับ">
                                                            เช็คข้อมูล
                                                    ...
                                                    @elseif ($item2->account_rep_active == 'REPFINISH')
                                                        ...
                                                        <button type="button" class="btn btn-success btn-sm shadow"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-custom-class="custom-tooltip"
                                                            data-bs-title="ลงบัญชีรับสำเร็จ">
                                                            &nbsp;&nbsp;สำเร็จ&nbsp;&nbsp;
                                                    ...
                                                    @else
                                                        {{-- status = REQUEST --}}
                                                        <button type="button" class="btn btn-info btn-sm shadow text-white editData"
                                                            value="{{ $item2->account_main_id }}"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-custom-class="custom-tooltip"
                                                            data-bs-title="ลงข้อมูลบัญชีรับ">
                                                            ลงข้อมูล
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="modal-title" id="myExtraLargeModalLabel" style="color: white">ลงข้อมูลบัญชีรายรับบุคลากร</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
