    ...
    <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header ">
                        <div class="row">
                            ...
                            <div class="col-md-4 ">
                               <button type="button" class="btn ms-3 text-danger" style="background-color: rgb(107, 239, 248)">ลงบัญชีรับ</button>
                               <button type="button" class="btn ms-3 text-danger" style="background-color: rgb(19, 184, 196)">เช็คบัญชีรับ</button>
                               <button type="button" class="btn ms-3 text-danger" style="background-color: rgb(156, 219, 7)">ลงบัญชีรับเรียบร้อย</button>
                           </div>
                                        ...
                                        @foreach ($datashow as $item2)
                                            ...
                                            <tr id="sid{{ $item2->account_main_id }}" style="{{ $color_new }}">
                                                ...
                                                @if ($item2->account_main_mounts == '1')
                                                    <td width="9%" class="p-2">มกราคม / {{ $yearthai }}
                                                    </td>
                                                @elseif ($item2->account_main_mounts == '2')
                                                    <td width="9%" class="p-2">กุมภาพันธ์ / {{ $yearthai }}
                                                    </td>
                                                @elseif ($item2->account_main_mounts == '3')
                                                    <td width="9%" class="p-2">มีนาคม / {{ $yearthai }}
                                                    </td>
                                                @elseif ($item2->account_main_mounts == '4')
                                                    <td width="9%" class="p-2">เมษายน / {{ $yearthai }}
                                                    </td>
                                                @elseif ($item2->account_main_mounts == '5')
                                                    <td width="9%" class="p-2">พฤษภาคม / {{ $yearthai }}
                                                    </td>
                                                @elseif ($item2->account_main_mounts == '6')
                                                    <td width="9%" class="p-2">มิถุนายน / {{ $yearthai }}
                                                    </td>
                                                @elseif ($item2->account_main_mounts == '7')
                                                    <td width="9%" class="p-2">กรกฎาคม / {{ $yearthai }}
                                                    </td>
                                                @elseif ($item2->account_main_mounts == '8')
                                                    <td width="9%" class="p-2">สิงหาคม / {{ $yearthai }}
                                                    </td>
                                                @elseif ($item2->account_main_mounts == '9')
                                                    <td width="9%" class="p-2">กันยายน / {{ $yearthai }}
                                                    </td>
                                                @elseif ($item2->account_main_mounts == '10')
                                                    <td width="9%" class="p-2">ตุลาคม / {{ $yearthai }}
                                                    </td>
                                                @elseif ($item2->account_main_mounts == '11')
                                                    <td width="9%" class="p-2">พฤษจิกายน /
                                                        {{ $yearthai }}</td>
                                                @else
                                                    <td width="9%" class="p-2">ธันวาคม / {{ $yearthai }}
                                                    </td>
                                                @endif
                                                ...
                                                <td width="5%" class="text-center">
                                                    ...
                                                    @if ($item2->account_rep_active == 'CHECK')
                                                        {{-- <button type="button" class="btn btn-outline-light btn-sm"
                                                            ...
                                                            data-bs-title="เช็คบัญชีรับเสร็จแล้วรอส่งข้อมูลไปบัญชีจ่าย">
                                                        ...
                                                        <button type="button" class="btn btn-outline-light btn-sm changstatus"
                                                            ...
                                                            <i class="fa-solid fa-share-from-square text-white" style="font-size:13px"></i>
                                                        </button>
                                                    @elseif ($item2->account_rep_active == 'TAKEDOWN')
                                                        {{-- status = TAKEDOWN --}}
                                                        <button type="button" class="btn btn-outline-warning btn-sm editData2"
                                                            value="{{ $item2->account_main_id }}"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-custom-class="custom-tooltip"
                                                            data-bs-title="เช็คการลงบัญชีรับ">
                                                            <i class="fa-solid fa-dollar-sign text-warning"
                                                                style="font-size:13px"></i>
                                                        </button>
                                                        {{-- <button type="button" class="btn btn-outline-warning btn-sm"
                                                            ...
                                                            <i class="fa-solid fa-share-from-square text-warning"
                                                                style="font-size:13px"></i>
                                                        </button>  --}}
                                                    @elseif ($item2->account_rep_active == 'REPFINISH')
                                                        ...
                                                        <button type="button" class="btn btn-outline-success btn-sm"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-custom-class="custom-tooltip"
                                                            data-bs-title="ลงบัญชีรับเรียบร้อย">
                                                        ...
                                                        {{-- <button type="button" class="btn btn-outline-danger btn-sm"
                                                            ...
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            data-bs-custom-class="custom-tooltip"
                                                            data-bs-title="ส่งข้อมูลไปบัญชีจ่ายเรียบร้อย">
                                                            <i class="fa-solid fa-share-from-square text-danger"
                                                                style="font-size:13px"></i>
                                                        </button>  --}}
                                                    @else
                                                        {{-- status = REQUEST --}}
                                                        ...
                                                        {{-- <button type="button" class="btn btn-outline-primary btn-sm"
                                                            ...
                                                            data-bs-title="ยังไม่ได้ลงบัญชีรับ-ส่งข้อมูลไปบัญชีจ่ายไม่ได้">
        ...
        <div class="modal fade" id="UpdatedataModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-xls">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myExtraLargeModalLabel">ลงข้อมูลบัญชีรายรับบุคลากร</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
         ...
         <div class="modal fade" id="Updatedata_checkModal" tabindex="-1" role="dialog"
         aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
         <div class="modal-dialog modal-xls">
             <div class="modal-content">
                 <div class="modal-header">
                     <h5 class="modal-title" id="myExtraLargeModalLabel">เช็คการลงข้อมูลรายรับบุคลากร</h5>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                 </div>
                 <div class="modal-body">
                     ...
                     <div class="row">
                         <div class="col-md-2">
                             <label for="">เลขที่บัญชี</label>
                             <div class="form-group mt-2">
                                 <input type="text" name="acc" id="editcheckacc"
                                     class="form-control form-control-sm">
                             </div>
                         </div>
                         <div class="col-md-2 ">
                             <label for="">เงินเดือน</label>
                             <div class="form-group mt-2 ">
                                 <input type="text" name="salary" id="editchecksalary"
                                     class="form-control form-control-sm text-end">
                             </div>
                         </div>
                         <div class="col-md-2">
                             <label for="">ตกเบิก</label>
                             <div class="form-group mt-2">
                                 <input type="text" name="backpay" id="editcheckbackpay"
                                     class="form-control form-control-sm text-end">
                             </div>
                         </div>
                         <div class="col-md-2">
                             <label for="">ปจต</label>
                             <div class="form-group mt-2">
                                 <input type="text" name="positionpay" id="editcheckpositionpay"
                                     class="form-control form-control-sm text-end">
                             </div>
                         </div>
                         <div class="col-md-1">
                             <label for="">8-11</label>
                             <div class="form-group mt-2">
                                 <input type="text" name="a0811" id="editchecka0811"
                                     class="form-control form-control-sm text-end">
                             </div>
                         </div>
                         <div class="col-md-1">
                             <label for="">ครองชีพ</label>
                             <div class="form-group mt-2">
                                 <input type="text" name="cost_of_living" id="editcheckcost_of_living"
                                     class="form-control form-control-sm text-end">
                             </div>
                         </div>
                         <div class="col-md-1">
                             <label for="">2%4%</label>
                             <div class="form-group mt-2">
                                 <input type="text" name="a24percent" id="editchecka24percent"
                                     class="form-control form-control-sm text-end">
                             </div>
                         </div>
                         <div class="col-md-1">
                             <label for="">OT</label>
                             <div class="form-group mt-2 ">
                                 <input type="text" name="ot" id="editcheckot"
                                     class="form-control form-control-sm text-end">
                             </div>
                         </div>
                     </div>
                 ...
                 <input type="hidden" name="account_main_id" id="editcheckaccount_main_id" class="form-control">
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.editData2', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            console.log(data.account.acc);
                            $('#editcheckacc').val(data.account.acc)
                            $('#editchecksalary').val(data.account.salary)
                            $('#editcheckbackpay').val(data.account.backpay)
                            $('#editcheckpositionpay').val(data.account.positionpay)
                            $('#editchecka0811').val(data.account.a0811)
                            $('#editcheckcost_of_living').val(data.account.cost_of_living)
                            $('#editchecka24percent').val(data.account.a24percent)
                            $('#editcheckot').val(data.account.ot)
                            $('#editcheckaccount_main_id').val(data.account.account_main_id)
                        },
                    });
                });
                $('#Updatedata_check').click(function() {
                    var account_main_id = $('#editcheckaccount_main_id').val();
                    var acc = $('#editcheckacc').val();
                    var salary = $('#editchecksalary').val();
                    var backpay = $('#editcheckbackpay').val();
                    var positionpay = $('#editcheckpositionpay').val();
                    var a0811 = $('#editchecka0811').val();
                    var cost_of_living = $('#editcheckcost_of_living').val();
                    var a24percent = $('#editchecka24percent').val();
                    var ot = $('#editcheckot').val();
                    $.ajax({
                        url: "{{ route('acc.account_money_personcheckupdate') }}",
                        type: "POST",
                        dataType: 'json',
                        data: {
                            account_main_id,
