                                    ...
                                    @foreach ($datashow as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{url('account_info_vn_subofcdetail_sub/'.$item->vn.'/'.$item->income)}}" target="_blank">{{ $item->paidst}}</a>  
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datashow2 as $item2)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $item2->rprice }}</td> 
                            ...
                            <table id="example3"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datashow3 as $item3)
                                        <tr>
                                            <td>{{ $i++ }}</td> 
                                            <td class="p-2">{{ $item3->outdate }}</td> 
                                            <td class="text-center">{{ $item3->staff_name }}</td>
                                            <td class="text-center">{{ $item3->intime }}</td>
                                            <td class="p-2">{{ $item3->from_department }}</td>
                                            <td class="text-center">{{ $item3->outtime }}</td>
                                            <td class="text-center">{{ $item3->to_department }}</td> 
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
