                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body shadow">
                            ...
                            <div class="tab-content" id="ex1-content">
                                <!-- ************ ส่งกลุ่มงาน ********************** -->
                                <div class="tab-pane fade show active" id="ex1-pills-2" role="tabpanel"
                                    aria-labelledby="ex1-tab-2">

                                    <form action="{{ route('book.bookmake_index_senddep') }}" id="Save_senddep"
                                        method="POST">
                                        @csrf
                                        <div class="row text-center">
                                            ...
                                            <div class="col-md-4 mt-5 mb-3">
                                                <div class="form-group">
                                                    <select id="dep" name="DEPARTMENT_ID" class="form-control"
                                            ...
                                            <div class="col-md-4 mt-5 mb-3">
                                                <div class="form-group">
                                                    <select id="book_objective" name="book_objective"
                                                        class="form-control" style="width: 100%" required>
                                                        <option value=""></option>
                                                        @foreach ($book_objective as $book)
                                                            <option value="{{ $book->objective_id }}">
                                                                {{ $book->objective_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                        ...
                        <div class="modal-body">
                            <form class="custom-validation" action="{{ route('book.comment1_save') }}" method="POST"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label for="pcustomer_code">{{ $dataedits->bookrep_usersend_name }}
                                            </label>
                                        </div>
                                    </div>
                                </div>
