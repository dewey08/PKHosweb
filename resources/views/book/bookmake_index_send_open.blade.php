                        ...
                        <ul class="nav nav-pills" id="ex1" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link btn-sm me-1" style="background-color: rgb(231, 227, 227)"
                                    ...
                                    <i class="fa-solid fa-swatchbook me-1 text-info"></i>
                                    <label
                            ...
                            <li class="nav-item" role="presentation">
                                ...
                                <i class="fa-solid fa-book-open me-1 text-white"></i>
                                    <label
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @foreach ($book_read as $item3)
                                                                        <tr id="sid{{ $item3->book_read_id }}">
                                                                            ...
                                                                            <td class="text-center" width="15%" style="font-size: 13px;">{{ $item3->book_read_open_date }}</td>
                                                                            <td class="text-center" width="15%" style="font-size: 13px;">{{ $item3->book_read_open_time }}</td>
                                                                        </tr>
                                                                    @endforeach
