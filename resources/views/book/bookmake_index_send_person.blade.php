    ...
    <script>
        ...
        function bookperson_destroy(sendperson_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('book/bookmake_sendperson_destroy') }}" + '/' + sendperson_id,
                        type: 'DELETE',
                        data: {
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    ...
                    <div class="tab-content" id="ex1-content">
                        <!-- ************ ส่งบุคคลากร ********************** -->
                        <div class="tab-pane fade show active" id="ex1-pills-4" role="tabpanel" aria-labelledby="ex1-tab-4">
                            {{-- <form action="{{ route('book.bookmake_index_sendperson') }}" id="Save_sendperson"
                                method="POST">
                                @csrf --}}
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-4 mt-5 mb-3">
                                        <div class="form-group">
                                            <select id="sendperson_user_id" name="sendperson_user_id" class="form-control"
                                    ...
                                    <div class="col-md-4 mt-5 mb-3">
                                        <div class="form-group">
                                            <select id="book_objective3" name="book_objective3" class="form-control"
                                                style="width: 100%" required>
                                                <option value=""></option>
...
<script>
    $(document).ready(function() {
        ...
        $('#saveBtn').click(function() {
                // alert('okkkkk');
                var sendperson_user_id = $('#sendperson_user_id').val(); // 
                var book_objective3 = $('#book_objective3').val(); // 
                ...
                $.ajax({
                    url: "{{ route('book.bookmake_index_sendperson') }}",
                    type: "POST",
                    dataType: 'json',
                    data: {
                        sendperson_user_id,
