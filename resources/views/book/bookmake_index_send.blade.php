                            ...
                            <div class="tab-content" id="ex1-content">
                                <div class="tab-pane fade show active" id="ex1-pills-1" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 text-center mt-4">
                                            <img src="{{ asset('assets/img/crut.png') }}" class="img-fluid hover-shadow mt-4"
                                                alt="Los Angeles Skyscrapers" width="150px" height="150px" />
                                        </div>

                                        <input type="hidden" id="bookrep_repnum" name="bookrep_repnum" class="form-control"
                                        ...
                                        <div class="col-md-9">
                                            <div class="row ">
                                                <div class="col-md-4 mt-3">
                                                    ...
                                                    <div class="form-outline ">
                                                        <input type="text" id="bookrep_recievenum"
                                                            name="bookrep_recievenum" class="form-control"
                                                            value="{{ $dataedits->bookrep_recievenum }}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mt-3">
                                                    <label class="form-label" for="bookrep_repbooknum">เลขที่หนังสือ</label>
                                                    <div class="form-outline ">
                                                        <input type="text" id="bookrep_repbooknum"
                                                            name="bookrep_repbooknum" class="form-control"
                                                            value="{{ $dataedits->bookrep_repbooknum }}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mt-3"> 
                                                    <label class="form-label"
                                                        for="bookrep_secret_class_name">ชั้นความลับ</label>
                                                    <div class="form-outline ">
                                                        <input id="bookrep_secret_class_name"
                                                            name="bookrep_secret_class_name" type="text"
                                                            class="form-control"
                                                            value="{{ $dataedits->bookrep_secret_class_name }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ">
                                                <div class="col-md-4 mt-3">
                                                    <label class="form-label"
                                                        for="bookrep_type_name">ประเภทหนังสือ</label>
                                                    <div class="form-outline ">
                                                        <input id="bookrep_type_name" name="bookrep_type_name"
                                                            type="text" class="form-control"
                                                            value="{{ $dataedits->bookrep_type_name }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mt-3">
                                                    <label class="form-label"
                                                        for="import_fam_name">นำเข้าไว้ในแฟ้ม</label>
                                                    <div class="form-outline ">
                                                        <input id="import_fam_name" name="import_fam_name" type="text"
                                                            class="form-control"
                                                            value="{{ $dataedits->import_fam_name }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mt-3">
                                                    <label class="form-label"
                                                    for="bookrep_speed_class_name">ชั้นความเร็ว</label>
                                                    <div class="form-outline ">
                                                        <input id="bookrep_speed_class_name"
                                                            name="bookrep_speed_class_name" type="text"
                                                            class="form-control"
                                                            value="{{ $dataedits->bookrep_speed_class_name }}">                                                       
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ">
                                                <div class="col-md-3 mt-3">
                                                    <label class="form-label" for="bookrep_save_date">ลงสมุดบันทึก
                                                        วันที่</label>
                                                    <div class="form-outline ">
                                                        <input id="bookrep_save_date" name="bookrep_save_date"
                                                            type="text" class="form-control"
                                                            value="{{ DateThai($dataedits->bookrep_save_date) }}">
                                                ...
                                                <div class="col-md-3 mt-3">
                                                    ...
                                                    <div class="form-outline ">
                                                        <input id="bookrep_save_time" name="bookrep_save_time"
                                                            type="text" class="form-control"
                                                            value="{{ $dataedits->bookrep_save_time }}">

                                                    </div>
                                                </div>
                                                <div class="col-md-3 mt-3">
                                                    <label class="form-label" for="bookrep_follow_date">ติดตาม ณ
                                                        วันที่</label>
                                                    <div class="form-outline ">
                                                        <input id="bookrep_follow_date" type="text"
                                                            class="form-control" name="start_date"
                                                            value="{{ DatetimeThai($dataedits->start_date) }}">                                                       
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mt-3">
                                                    <label class="form-label" for="bookrep_save_time">เวลา</label>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-9 mt-3">
                                            ...
                                            <div class="form-outline ">
                                                <input type="text" id="bookrep_name" name="bookrep_name"
                                                    class="form-control" value="{{ $dataedits->bookrep_name }}" />
                                    ...
                                    <div class="row mt-3 ">
                                        ...
                                        <div class="col-md-9 mt-3">
                                            <label class="form-label" for="bookrep_assembly">
                                                เรื่องเดิม .. , สรุปเรื่อง .. , ข้อมูล กฎระเบียบที่เกี่ยวข้อง .. ,
                                                ข้อเสนอเพื่อพิจารณา ..
                                            </label>
                                            <div class="form-outline ">
                                    ...
                                    <div class="row mt-3 ">
                                        ...
                                        <div class="col-md-9 mt-3">
                                            <label class="form-label" for="bookrep_name">ความเห็นที่ 1
                                                &nbsp;&nbsp;&nbsp;&nbsp; </label>
                                            <div class="form-outline ">
                                    ...
                                    <div class="row mt-3 ">
                                        ...
                                        <div class="col-md-9 mt-3">
                                            <label class="form-label" for="bookrep_name">ความเห็นที่ 2
                                                &nbsp;&nbsp;&nbsp;&nbsp; </label>
                                            <div class="form-outline ">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-9 mt-3">
                                            <label class="form-label" for="bookrep_name">ความเห็น ผอ.
                                                &nbsp;&nbsp;&nbsp;&nbsp;</label>
                                            <div class="form-outline ">
                                ...
                                <div class="tab-pane fade" id="ex1-pills-6" role="tabpanel" aria-labelledby="ex1-tab-6">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-9 mt-3">
                                            <div class="input-group  p-2 me-2">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card-body fpdf shadow-lg ">
                                                ...
                                                @else
                                                    ...
                                                    <iframe
                                                        src="{{ asset('storage/bookrep_pdf/' . $dataedits->bookrep_file) }}"
