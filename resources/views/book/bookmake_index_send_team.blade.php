                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-md-4 mt-5 mb-3">
                                    <div class="form-group">
                                        <select id="org_team_id" name="org_team_id" class="form-control"
                                            style="width: 100%" required>
                                            <option value=""></option>
                                            @foreach ($org_team as $team)
                                                <option value="{{ $team->org_team_id }}">{{ $team->org_team_detail }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4 mt-5 mb-3">
                                    <div class="form-group">
                                        <select id="book_objective5" name="book_objective5" class="form-control"
                                            style="width: 100%" required>
                                            <option value=""></option>
                                                ...
                                                <tr id="sid{{ $item5->sendteam_id }}">
                                                    ...
                                                    <td class="text-center" width="10%">
                                                        ...
                                                        <a class="text-danger" href="javascript:void(0)"
                                                            onclick="booksendteam_destroy({{ $item5->sendteam_id }})"
