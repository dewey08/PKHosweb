                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <?php $number++;  ?>
                                                                            <tr> 
                                                                                ...
                                                                                <td class="text-font" align="center"><input id="p4p_workload_1" class="form-control form-control-sm" name="p4p_workload_1" value="{{$item->p4p_workload_1}}"> </td> 
                                                                                <td class="text-font" align="center"><input id="p4p_workload_2" class="form-control form-control-sm" name="p4p_workload_2"> 1</td> 
                                                                                <td class="text-font" align="center"><input id="p4p_workload_2" class="form-control form-control-sm" name="p4p_workload_2">2 </td> 
                                                                                <td class="text-font" align="center"><input id="p4p_workload_2" class="form-control form-control-sm" name="p4p_workload_2"> 3</td> 
