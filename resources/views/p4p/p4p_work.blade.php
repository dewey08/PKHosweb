                                                ...
                                                @foreach ($p4p_work as $item) 
                                                    <tr id="sid{{ $item->p4p_work_id }}">   
                                                        ...
                                                        <td class="text-center" width="10%" style="font-size:12px">
                                                            ...
                                                            <a href="{{url('p4p_work_choose_detail/'.$item->p4p_work_id)}}" class="btn btn-outline-info btn-sm" data-bs-toggle="tooltip" >
                                                                <i class="fa-solid fa-circle-info me-2 text-info" style="font-size:13px"></i> 
                                                                รายละเอียด P4P
                                                            </a>
                                                            <a href="{{url('p4p_work_choose/'.$item->p4p_work_id)}}" class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" >
                                                                <i class="fa-solid fa-circle-info me-2 text-info" style="font-size:13px"></i> 
                                                                บันทึก P4P
                                                            </a>
                                                            {{-- <a href="{{url('p4p_work_choose/'.$item->p4p_work_year.'/'.$item->MONTH_ID)}}" class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" >
                                                                <i class="fa-solid fa-circle-info me-2 text-info" style="font-size:13px"></i> 
                                                                บันทึก P4P
                                                            </a> --}}
