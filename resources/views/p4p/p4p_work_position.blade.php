                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input id="p4p_work_position_code" type="text" class="form-control form-control-sm"
                                        name="p4p_work_position_code" value="{{$refpositionnumber}}" readonly>
                                </div>
                            </div> 
                            <div class="col-md-2 text-end">
                                                        ...
                                                        <td class="text-center" width="5%">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <a class="dropdown-item menu btn btn-outline-warning btn-sm"
                                                                       href="{{url('p4p_work_position_sub/'.$item->p4p_work_position_id)}}"
                                                                        data-bs-toggle="tooltip" data-bs-placement="left" title="เพิ่มภาระงาน">
                                                                        <i class="fa-solid fa-circle-plus me-2"
                                                                            style="color: rgb(23, 168, 252)"></i>
                                                                        <label for=""
                                                                            style="color: rgb(23, 168, 252)">เพิ่มภาระงาน</label>
                                                                    </a>
                                                                </ul>
                                                            </div>
                                                        </td> 
...
<script>
        $(document).ready(function() {
            ...
            $('#Savebtn').click(function() {
                ...
                $.ajax({
                    url: "{{ route('p4.p4p_work_position_save') }}",
                    type: "POST",
                    dataType: 'json',
                    data: {
