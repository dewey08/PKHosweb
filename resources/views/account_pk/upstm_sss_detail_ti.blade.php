                ...
                <div class="col-md-3">                               
                    <div class="nav flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <div class="card p-4 card-ofc">
                            <h4 class="card-title" style="color:rgb(10, 151, 85)">STM DETAIL SSS OPD </h4>
                                        ...
                                        @foreach ($sss_ti as $item_1)
                                            ...
                                            <tr height="20"> 
                                                <td class="text-start" style="color:rgb(34, 90, 243);font-size:15px"> 
                                                    <a href="{{url('upstm_sss_detail_ti/'.$item_1->STMDoc)}}"> {{ $item_1->STMDoc }}</a>  
                                                </td>   
                                            </tr>
                                        @endforeach 
                                    </tbody> 
                    ...
                    <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-ucs" role="tabpanel" aria-labelledby="v-pills-ucs-tab">
                            <div class="row"> 
                                <div class="col-md-12">
                                    <div class="card p-4 card-ofc">
                                        <h4 class="card-title" style="color:rgb(10, 151, 85)">STM DETAIL SSS OPD :::: >> {{$STMDoc}}</h4>
                                        <div class="table-responsive">
