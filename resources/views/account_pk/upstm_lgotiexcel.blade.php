            ...
            <div class="col-xl-8 col-md-6">
                <div class="main-card mb-3 card">
                    <div class="grid-menu-col">
                        <form action="{{ route('acc.upstm_lgotiexcel_save') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 mt-3">
                                        <label for="formFileLg" class="form-label">UP STM Ti EXCEL </label>
                                        <input class="form-control form-control-lg" id="formFileLg" name="file"
                                            type="file" required>
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    </div>
                                    @if ($countc > 0)  
                                        <a href="{{ url('upstm_lgotiexcel_senddata') }}" class="mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-primary" id="Senddata">
                    ...
                    <div class="grid-menu-col">
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    @endif
                                        <td class="p-2" style="color:rgb(248, 12, 12)" width="10%"> {{ $item->cid }}</td>
                                        <td class="p-2" style="color:rgb(248, 12, 12)" > {{ $item->ptname }}</td>
                                        <td class="p-2" style="color:rgb(248, 12, 12)" width="20%"> {{ $item->STMdoc }}</td>
                                    </tr>
                                @endforeach
                ...
                complete: function(xhr) { 
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location = "{{ url('upstm_lgotiexcel') }}";
                        }
                    })
                }
            })
