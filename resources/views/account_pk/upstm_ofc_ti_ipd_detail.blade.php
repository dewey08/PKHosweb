        ...
        <div class="tabs-animation">
            ...
            <div class="row"> 
                ...
                <div class="col-md-2 text-end">
                    <a href="{{url('upstm_ofc_ti_ipd')}}" class="ladda-button btn-pill btn btn-primary d-shadow me-2 ms-4" data-style="expand-left">
                                        ...
                                        @foreach ($ofc_ti_ipd as $item_1)
                                            ...
                                            <tr height="20"> 
                                                <td class="text-start" style="color:rgb(34, 90, 243);font-size:15px">  
                                                    <a href="{{url('upstm_ofc_ti_ipd_detail/'.$item_1->STMDoc)}}"> {{ $item_1->STMDoc }}</a>  
                                                </td>  
