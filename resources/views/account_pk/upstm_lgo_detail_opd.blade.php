                                        ...
                                        <div class="table-responsive">
                                            {{-- <table id="example2" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0; width: 100%;"> --}}
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($datashow as $item)
                                                        ...
                                                        <tr height="20">
                                                            ...
                                                            <td class="text-center" style="color:rgb(10, 151, 85);font-size:15px" width="10%">{{ number_format($item->claim_true_af, 2) }}</td>
                                                            <td class="text-center" style="color:rgb(10, 151, 85);font-size:15px" width="10%">{{ number_format($item->price1_k, 2) }}</td>
                                                        </tr>
                                                        <?php
                                                ...
                                                <tr style="background-color: #f3fca1">
                                                    ...
                                                    <td class="text-center" style="background-color: rgb(10, 151, 85)"><label for="" style="color: #FFFFFF">{{ number_format($total4, 2) }}</label> </td> 
                                                </tr>  
                                            </table>
                                        </div>
                                    </div>
