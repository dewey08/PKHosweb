                                        ...
                                        <div class="row"> 
                                            <div class="col-md-6">
                                                <div class="card p-4 card_pink">
                                                    <h4 class="card-title" style="color:rgb(10, 151, 85)">STM DETAIL LGO TI 8011</h4>
                                                                ...
                                                                @foreach ($lgo_ti as $item)
                                                                    ...
                                                                    <tr height="20">
                                                                        ...
                                                                        <td class="text-start" style="color:rgb(34, 90, 243);font-size:15px">  
                                                                            <a href="{{url('upstm_lgo_ti_detail/'.$item->STMDoc)}}" target="_blank"> {{ $item->STMDoc }}</a>  
                                                                        </td>  
