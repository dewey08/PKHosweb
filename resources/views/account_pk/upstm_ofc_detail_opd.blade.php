                                        ...
                                        @foreach ($ofc_opd as $item_1)
                                            ...
                                            <tr height="20"> 
                                                <td class="text-start" style="color:rgb(34, 90, 243);font-size:15px"> 
                                                    <a href="{{url('upstm_ofc_detail_opd/'.$item_1->STMDoc)}}"> {{ $item_1->STMDoc }}</a>  
                                                </td>   
                                            </tr>
                                        @endforeach 
                                    </tbody> 
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($datashow as $item)
                                                        ...
                                                        <tr height="20">
                                                            ...
                                                            <td class="text-center" style="color:rgb(10, 151, 85);font-size:15px" width="10%">{{ number_format($item->pricereq_all, 2) }}</td> 
                                                        </tr>
                                                        <?php
                                                                $total1 = $total1 + $item->income;
                                                                $total2 = $total2 + $item->debit_total;
                                                                $total3 = $total3 + $item->pricereq_all;  
                                                        ?> 
                                                    @endforeach                    
                                                </tbody> 
