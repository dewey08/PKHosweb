        ...
        <div class="tabs-animation">
            ...
            <div class="row"> 
                ...
                <div class="col-md-2 text-end">
                    <a href="{{url('upstm_lgo_opd')}}" class="ladda-button btn-pill btn btn-primary d-shadow me-2 ms-4" data-style="expand-left">
                ...
                <div class="col-md-4">                               
                    <div class="nav flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <div class="card p-4 card-ofc">
                            <h4 class="card-title" style="color:rgb(10, 151, 85)">STM DETAIL LGO OPD 801</h4>
                                        ...
                                        @foreach ($lgo_opd as $item_1)
                                            ...
                                            <tr height="20"> 
                                                <td class="text-start" style="color:rgb(34, 90, 243);font-size:15px"> 
                                                    <a href="{{url('upstm_lgo_opd_detail/'.$item_1->STMDoc)}}"> {{ $item_1->STMDoc }}</a>  
                                                </td>  
