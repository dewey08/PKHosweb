        ...
        <div class="tabs-animation">
            ...
            <div class="row"> 
                ...
                <div class="col-md-2 text-end">
                    <a href="{{url('upstm_sss_ti')}}" class="ladda-button btn-pill btn btn-primary d-shadow me-2 ms-4" data-style="expand-left">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped table-bordered "
                                    ...
                                    <tbody>
                                        <?php $number = 0;
                                        $total1 = 0; ?>
                                        @foreach ($sss_ti as $item_1)
                                            <?php $number++; ?> 
                                            <tr height="20"> 
                                                <td class="text-start" style="color:rgb(34, 90, 243);font-size:15px">  
                                                    <a href="{{url('upstm_sss_ti_detail/'.$item_1->STMDoc)}}"> {{ $item_1->STMDoc }}</a>  
                                                </td>  
                    ...
                    <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-ucs" role="tabpanel" aria-labelledby="v-pills-ucs-tab">
                            <div class="row"> 
                                <div class="col-md-12">
                                    <div class="card p-4 card_pink">
                                        <h4 class="card-title" style="color:rgb(10, 151, 85)">STM DETAIL SSS TI :::: >> {{$STMDoc}}</h4>
                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($datashow as $item)
                                                        ...
                                                        <tr height="20">
                                                            ...
                                                            <td class="text-center" style="color:rgb(10, 151, 85);font-size:15px" width="10%">{{ number_format($item->stm_total, 2) }}</td> 
                                                        </tr>
                                                        <?php
