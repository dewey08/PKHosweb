                ...
                <div class="col-md-6 text-center">
                    <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy"
                        ...
                        <input type="text" class="form-control" name="startdate" id="datepicker" placeholder="Start Date"
                            ...
                            data-date-autoclose="true" data-date-language="th-th" value="{{ $start }}" />
                        ...
                        <a href="{{ url('aipn_send_all') }}" class="btn btn-success"><i
                                class="fa-solid fa-arrow-up-right-from-square me-2"></i>ส่งออก</a>
                        <a href="{{ url('aipn_zip') }}" class="btn btn-danger"><i
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <div class="input-group" id="datepicker1">
                        ...
                        <a href="{{ url('aipn_send_an') }}" class="btn btn-success"><i
                                class="fa-solid fa-arrow-up-right-from-square me-2"></i>ส่งออก</a>
                        <a href="{{ url('aipn_zip') }}" class="btn btn-danger"><i
                                class="fa-solid fa-file-zipper me-2"></i>ZipFile</a>
                                            ...
                                            @foreach ($aipn_billitems as $item2)
                                                <tr id="sidb{{ $item2->aipn_billitems_id }}" style="font-size: 12px;">
                                                    ...
                                                    <td class="text-center" width="10%">
                                                        ...
                                                        <a href="{{ url('aipn_billitems_destroy/' . $item2->aipn_billitems_id) }}"
