            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">การตรวจคัดกรองวินิจฉัยให้แว่นตาสำหรับเด็ก</h4>
                        <p class="card-title-desc">รายการกิจกรรมย่อย แว่นตาเด็ก</p>
                                ...
                                <div class="col-md-12">
                                    <div class="card mb-1 shadow-none">
                                        ...
                                        <div id="collapseOne" class="collapse"
                                            ...
                                            <div class="card-body">
                                                <form action="{{ route('k.ktb_kids_glasses_search') }}" method="POST">
                                                    @csrf 
                                                    <div class="row"> 
