                        ...
                        <div class="row">                            
                            ...
                            <div class="col-md-6 text-center">
                                <div class="input-group" id="datepicker1">
                                    ...
                                    <a href="{{url('anc_dent_send16')}}" class="btn btn-success"><i class="fa-solid fa-arrow-up-right-from-square me-2"></i>ส่งออก</a>    
                                    <a href="{{url('anc_dent_zip')}}" class="btn btn-danger"><i class="fa-solid fa-file-zipper me-2"></i>ZipFile</a>   
                                </div>
                            </div>    
                            <div class="col"></div>
                        </div>
