        ...
        <div id="preloader">
            <div id="status">
                <div class="spinner">
                    ...
                    <form action="{{ route('claim.aipn_disability_search') }}" method="POST">
                    @csrf
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <h4 class="card-title">Detail AIPN DISABILITY</h4>
                                <p class="card-title-desc">รายละเอียดประกันสังคมผู้ป่วยใน ทุภพพลภาพ</p>
                            </div>
                            <div class="col"></div>
