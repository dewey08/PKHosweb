                                        ...
                                        <div class="table-responsive"> 
                                            ...
                                            <thead> 
                                                <tr> 
                                                    ...
                                                    <th class="text-center">แต้ม/ชิ้นงาน </th>   
                                                    <th class="text-center">รวมชิ้นงาน </th>  
                                                    <th class="text-center">รวมแต้ม </th>  
                                                ...
                                                @foreach ($p4p_workload as $item)
                                                    ...
                                                    ?> 
                                                        ...
                                                        <tr>  
                                                            ...
                                                            <td class="text-center" style="font-size: 13px;width: 15%"><label for="" style="font-size: 13px;">{{$item->p4p_workset_score}}</label> </td> 
                                                            <td class="text-center" style="font-size: 13px;width: 8%"><label for="" style="font-size: 13px;">{{$qty}}</label></td> 
                                                            <td class="text-center" style="font-size: 13px;width: 15%"> <label for="" style="font-size: 13px;">{{$item->p4p_workload_sum}}</label> </td> 
                                                        ...
                                                        <?php
                                                        // $total = $total + $item3->p4p_workload_sum * $item3->product_price;
                                                        // $total_1 = $total_1 + $qty;
                                                        ?>
                                                @endforeach
