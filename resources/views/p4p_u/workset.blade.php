                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-2">
                                <div class="form-group"> 
                                        ...
                                        @if ($group_p4p ==$itewo->p4p_work_position_id )
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <a class="dropdown-item menu btn btn-outline-warning btn-sm"
                                                                       href="{{url('workset_edit/'.$item->p4p_workset_id)}}"
